...
rule Rule_760_triggered {
	meta: description = "Rule # 760 Suspicious String RxR triggered"
	strings: $suspicious_string = "RxR"
	condition: $suspicious_string
}
rule Rule_761_triggered {
	meta: description = "Rule # 761 Suspicious String Ryan Duff and Firas Durri triggered"
	strings: $suspicious_string = "Ryan Duff and Firas Durri"
	condition: $suspicious_string
}
rule Rule_762_triggered {
	meta: description = "Rule # 762 Suspicious String Rytz triggered"
	strings: $suspicious_string = "Rytz"
	condition: $suspicious_string
}
rule Rule_763_triggered {
	meta: description = "Rule # 763 Suspicious String S-Man triggered"
	strings: $suspicious_string = "S-Man"
	condition: $suspicious_string
}
rule Rule_764_triggered {
	meta: description = "Rule # 764 Suspicious String S4!Lh34t triggered"
	strings: $suspicious_string = "S4!Lh34t"
	condition: $suspicious_string
}
rule Rule_765_triggered {
	meta: description = "Rule # 765 Suspicious String S4MP4H triggered"
	strings: $suspicious_string = "S4MP4H"
	condition: $suspicious_string
}
rule Rule_766_triggered {
	meta: description = "Rule # 766 Suspicious String SAMPAH triggered"
	strings: $suspicious_string = "SAMPAH"
	condition: $suspicious_string
}
rule Rule_767_triggered {
	meta: description = "Rule # 767 Suspicious String SCAM PAGE PPL V5 triggered"
	strings: $suspicious_string = "SCAM PAGE PPL V5"
	condition: $suspicious_string
}
rule Rule_768_triggered {
	meta: description = "Rule # 768 Suspicious String SCAM PAYPAL triggered"
	strings: $suspicious_string = "SCAM PAYPAL"
	condition: $suspicious_string
}
rule Rule_769_triggered {
	meta: description = "Rule # 769 Suspicious String SCAMA triggered"
	strings: $suspicious_string = "SCAMA"
	condition: $suspicious_string
}
rule Rule_770_triggered {
	meta: description = "Rule # 770 Suspicious String SCYTHE404_LOL triggered"
	strings: $suspicious_string = "SCYTHE404_LOL"
	condition: $suspicious_string
}
rule Rule_771_triggered {
	meta: description = "Rule # 771 Suspicious String SHADOW Z118 triggered"
	strings: $suspicious_string = "SHADOW Z118"
	condition: $suspicious_string
}
rule Rule_772_triggered {
	meta: description = "Rule # 772 Suspicious String SILVER FOX triggered"
	strings: $suspicious_string = "SILVER FOX"
	condition: $suspicious_string
}
rule Rule_773_triggered {
	meta: description = "Rule # 773 Suspicious String SKSking triggered"
	strings: $suspicious_string = "SKSking"
	condition: $suspicious_string
}
rule Rule_774_triggered {
	meta: description = "Rule # 774 Suspicious String SMTP Grabber triggered"
	strings: $suspicious_string = "SMTP Grabber"
	condition: $suspicious_string
}
rule Rule_775_triggered {
	meta: description = "Rule # 775 Suspicious String SNMP cracker triggered"
	strings: $suspicious_string = "SNMP cracker"
	condition: $suspicious_string
}
rule Rule_776_triggered {
	meta: description = "Rule # 776 Suspicious String SQL CMD 3.0 | al-swisre triggered"
	strings: $suspicious_string = "SQL CMD 3.0 | al-swisre"
	condition: $suspicious_string
}
rule Rule_777_triggered {
	meta: description = "Rule # 777 Suspicious String SQL_CMD 3.0 by al-swisre triggered"
	strings: $suspicious_string = "SQL_CMD 3.0 by al-swisre"
	condition: $suspicious_string
}
rule Rule_778_triggered {
	meta: description = "Rule # 778 Suspicious String SQli 1.0 Exploiter  triggered"
	strings: $suspicious_string = "SQli 1.0 Exploiter "
	condition: $suspicious_string
}
rule Rule_779_triggered {
	meta: description = "Rule # 779 Suspicious String SUNUCU HAKKINDA triggered"
	strings: $suspicious_string = "SUNUCU HAKKINDA"
	condition: $suspicious_string
}
rule Rule_780_triggered {
	meta: description = "Rule # 780 Suspicious String SYMLINKER BY GRAY BYTE triggered"
	strings: $suspicious_string = "SYMLINKER BY GRAY BYTE"
	condition: $suspicious_string
}
rule Rule_781_triggered {
	meta: description = "Rule # 781 Suspicious String SaM Shell triggered"
	strings: $suspicious_string = "SaM Shell"
	condition: $suspicious_string
}
rule Rule_782_triggered {
	meta: description = "Rule # 782 Suspicious String SaTtAr triggered"
	strings: $suspicious_string = "SaTtAr"
	condition: $suspicious_string
}
rule Rule_783_triggered {
	meta: description = "Rule # 783 Suspicious String Sadrazam SHELL triggered"
	strings: $suspicious_string = "Sadrazam SHELL"
	condition: $suspicious_string
}
rule Rule_784_triggered {
	meta: description = "Rule # 784 Suspicious String SahaainG triggered"
	strings: $suspicious_string = "SahaainG"
	condition: $suspicious_string
}
rule Rule_785_triggered {
	meta: description = "Rule # 785 Suspicious String Saliy Tool triggered"
	strings: $suspicious_string = "Saliy Tool"
	condition: $suspicious_string
}
rule Rule_786_triggered {
	meta: description = "Rule # 786 Suspicious String Sanjungan Jiwa Team triggered"
	strings: $suspicious_string = "Sanjungan Jiwa Team"
	condition: $suspicious_string
}
rule Rule_787_triggered {
	meta: description = "Rule # 787 Suspicious String Saudi Attacker triggered"
	strings: $suspicious_string = "Saudi Attacker"
	condition: $suspicious_string
}
rule Rule_788_triggered {
	meta: description = "Rule # 788 Suspicious String Say To Safemode Go To HeLl By php.ini triggered"
	strings: $suspicious_string = "Say To Safemode Go To HeLl By php.ini"
	condition: $suspicious_string
}
rule Rule_789_triggered {
	meta: description = "Rule # 789 Suspicious String ScarleT7 triggered"
	strings: $suspicious_string = "ScarleT7"
	condition: $suspicious_string
}
rule Rule_790_triggered {
	meta: description = "Rule # 790 Suspicious String Scorpiol triggered"
	strings: $suspicious_string = "Scorpiol"
	condition: $suspicious_string
}
rule Rule_791_triggered {
	meta: description = "Rule # 791 Suspicious String Script Resetpass CP triggered"
	strings: $suspicious_string = "Script Resetpass CP"
	condition: $suspicious_string
}
rule Rule_792_triggered {
	meta: description = "Rule # 792 Suspicious String Sec BY Jonior.com triggered"
	strings: $suspicious_string = "Sec BY Jonior.com"
	condition: $suspicious_string
}
rule Rule_793_triggered {
	meta: description = "Rule # 793 Suspicious String Secsion<infos@hacker_Shenzen> triggered"
	strings: $suspicious_string = "Secsion<infos@hacker_Shenzen>"
	condition: $suspicious_string
}
rule Rule_794_triggered {
	meta: description = "Rule # 794 Suspicious String Security Angel Team [S4T] triggered"
	strings: $suspicious_string = "Security Angel Team [S4T]"
	condition: $suspicious_string
}
rule Rule_795_triggered {
	meta: description = "Rule # 795 Suspicious String Security Cyber Art triggered"
	strings: $suspicious_string = "Security Cyber Art"
	condition: $suspicious_string
}
rule Rule_796_triggered {
	meta: description = "Rule # 796 Suspicious String Security Ghost triggered"
	strings: $suspicious_string = "Security Ghost"
	condition: $suspicious_string
}
rule Rule_797_triggered {
	meta: description = "Rule # 797 Suspicious String SecurityBus triggered"
	strings: $suspicious_string = "SecurityBus"
	condition: $suspicious_string
}
rule Rule_798_triggered {
	meta: description = "Rule # 798 Suspicious String Setor PP Boz triggered"
	strings: $suspicious_string = "Setor PP Boz"
	condition: $suspicious_string
}
rule Rule_799_triggered {
	meta: description = "Rule # 799 Suspicious String Sh4hien triggered"
	strings: $suspicious_string = "Sh4hien"
	condition: $suspicious_string
}
rule Rule_800_triggered {
	meta: description = "Rule # 800 Suspicious String Shalyse triggered"
	strings: $suspicious_string = "Shalyse"
	condition: $suspicious_string
}
rule Rule_801_triggered {
	meta: description = "Rule # 801 Suspicious String Shardhanand triggered"
	strings: $suspicious_string = "Shardhanand"
	condition: $suspicious_string
}
rule Rule_802_triggered {
	meta: description = "Rule # 802 Suspicious String Sheko H4CK3R triggered"
	strings: $suspicious_string = "Sheko H4CK3R"
	condition: $suspicious_string
}
rule Rule_803_triggered {
	meta: description = "Rule # 803 Suspicious String Shell Accessed!!! triggered"
	strings: $suspicious_string = "Shell Accessed!!!"
	condition: $suspicious_string
}
rule Rule_804_triggered {
	meta: description = "Rule # 804 Suspicious String Shell Checker triggered"
	strings: $suspicious_string = "Shell Checker"
	condition: $suspicious_string
}
rule Rule_805_triggered {
	meta: description = "Rule # 805 Suspicious String Shell Finder triggered"
	strings: $suspicious_string = "Shell Finder"
	condition: $suspicious_string
}
rule Rule_806_triggered {
	meta: description = "Rule # 806 Suspicious String Shell Recoded From IndoXploit Shell triggered"
	strings: $suspicious_string = "Shell Recoded From IndoXploit Shell"
	condition: $suspicious_string
}
rule Rule_807_triggered {
	meta: description = "Rule # 807 Suspicious String ShinChan triggered"
...
rule Rule_809_triggered {
	meta: description = "Rule # 809 Suspicious String Shindex404     triggered"
	strings: $suspicious_string = "Shindex404    "
	condition: $suspicious_string
}
rule Rule_810_triggered {
	meta: description = "Rule # 810 Suspicious String Shut_Down404  triggered"
	strings: $suspicious_string = "Shut_Down404 "
	condition: $suspicious_string
}
rule Rule_811_triggered {
	meta: description = "Rule # 811 Suspicious String Silent poison India triggered"
	strings: $suspicious_string = "Silent poison India"
	condition: $suspicious_string
}
rule Rule_812_triggered {
	meta: description = "Rule # 812 Suspicious String Siliwangi triggered"
	strings: $suspicious_string = "Siliwangi"
	condition: $suspicious_string
}
rule Rule_813_triggered {
	meta: description = "Rule # 813 Suspicious String Siluman nanas triggered"
	strings: $suspicious_string = "Siluman nanas"
	condition: $suspicious_string
}
rule Rule_814_triggered {
	meta: description = "Rule # 814 Suspicious String Skidie Khan triggered"
	strings: $suspicious_string = "Skidie Khan"
	condition: $suspicious_string
}
rule Rule_815_triggered {
	meta: description = "Rule # 815 Suspicious String Something is wrong. Download - IS NOT OK triggered"
	strings: $suspicious_string = "Something is wrong. Download - IS NOT OK"
	condition: $suspicious_string
}
rule Rule_816_triggered {
	meta: description = "Rule # 816 Suspicious String Special Thanks To MadLeets triggered"
	strings: $suspicious_string = "Special Thanks To MadLeets"
	condition: $suspicious_string
}
rule Rule_817_triggered {
	meta: description = "Rule # 817 Suspicious String SpecimenT triggered"
	strings: $suspicious_string = "SpecimenT"
	condition: $suspicious_string
}
rule Rule_818_triggered {
	meta: description = "Rule # 818 Suspicious String Spirit Hunder triggered"
	strings: $suspicious_string = "Spirit Hunder"
	condition: $suspicious_string
}
rule Rule_819_triggered {
	meta: description = "Rule # 819 Suspicious String SpyHackerz.Com triggered"
	strings: $suspicious_string = "SpyHackerz.Com"
	condition: $suspicious_string
}
rule Rule_820_triggered {
	meta: description = "Rule # 820 Suspicious String Spyk1r4 triggered"
	strings: $suspicious_string = "Spyk1r4"
	condition: $suspicious_string
}
rule Rule_821_triggered {
	meta: description = "Rule # 821 Suspicious String Stealth MultiFunctional IrcBot writen in Perl triggered"
	strings: $suspicious_string = "Stealth MultiFunctional IrcBot writen in Perl"
	condition: $suspicious_string
}
rule Rule_822_triggered {
	meta: description = "Rule # 822 Suspicious String Stealth Shellbot triggered"
	strings: $suspicious_string = "Stealth Shellbot"
	condition: $suspicious_string
}
rule Rule_823_triggered {
	meta: description = "Rule # 823 Suspicious String Stm Nazie 102 triggered"
	strings: $suspicious_string = "Stm Nazie 102"
	condition: $suspicious_string
}
rule Rule_824_triggered {
	meta: description = "Rule # 824 Suspicious String Stupidc0de Family triggered"
	strings: $suspicious_string = "Stupidc0de Family"
	condition: $suspicious_string
}
rule Rule_825_triggered {
	meta: description = "Rule # 825 Suspicious String SuLiMaN.HackeR triggered"
	strings: $suspicious_string = "SuLiMaN.HackeR"
	condition: $suspicious_string
}
rule Rule_826_triggered {
	meta: description = "Rule # 826 Suspicious String Success Upload :D triggered"
	strings: $suspicious_string = "Success Upload :D"
	condition: $suspicious_string
}
rule Rule_827_triggered {
	meta: description = "Rule # 827 Suspicious String Successfully R00T(ed) triggered"
	strings: $suspicious_string = "Successfully R00T(ed)"
	condition: $suspicious_string
}
rule Rule_828_triggered {
	meta: description = "Rule # 828 Suspicious String Sukses Deface triggered"
	strings: $suspicious_string = "Sukses Deface"
	condition: $suspicious_string
}
rule Rule_829_triggered {
	meta: description = "Rule # 829 Suspicious String SultanHaikal triggered"
	strings: $suspicious_string = "SultanHaikal"
	condition: $suspicious_string
}
rule Rule_830_triggered {
	meta: description = "Rule # 830 Suspicious String Suç İşleyeceksen Sanat'a Çevir triggered"
	strings: $suspicious_string = "Suç İşleyeceksen Sanat'a Çevir"
	condition: $suspicious_string
}
rule Rule_831_triggered {
	meta: description = "Rule # 831 Suspicious String Sy-Hacker triggered"
	strings: $suspicious_string = "Sy-Hacker"
	condition: $suspicious_string
}
rule Rule_832_triggered {
	meta: description = "Rule # 832 Suspicious String Symlink Based Cpanel Cracker triggered"
	strings: $suspicious_string = "Symlink Based Cpanel Cracker"
	condition: $suspicious_string
}
rule Rule_833_triggered {
	meta: description = "Rule # 833 Suspicious String Symlink ByPass triggered"
	strings: $suspicious_string = "Symlink ByPass"
	condition: $suspicious_string
}
rule Rule_834_triggered {
	meta: description = "Rule # 834 Suspicious String Symlink Bypass 2014 by Faisal 1337 triggered"
	strings: $suspicious_string = "Symlink Bypass 2014 by Faisal 1337"
	condition: $suspicious_string
}
rule Rule_835_triggered {
	meta: description = "Rule # 835 Suspicious String Symlink Config Graber triggered"
	strings: $suspicious_string = "Symlink Config Graber"
	condition: $suspicious_string
}
rule Rule_836_triggered {
	meta: description = "Rule # 836 Suspicious String Symlink based cpanel cracking triggered"
	strings: $suspicious_string = "Symlink based cpanel cracking"
	condition: $suspicious_string
}
rule Rule_837_triggered {
	meta: description = "Rule # 837 Suspicious String Syntax-True triggered"
	strings: $suspicious_string = "Syntax-True"
	condition: $suspicious_string
}
rule Rule_838_triggered {
	meta: description = "Rule # 838 Suspicious String SyntaxNotFound triggered"
	strings: $suspicious_string = "SyntaxNotFound"
	condition: $suspicious_string
}
rule Rule_839_triggered {
	meta: description = "Rule # 839 Suspicious String SystemX64MGB  triggered"
	strings: $suspicious_string = "SystemX64MGB "
	condition: $suspicious_string
}
rule Rule_840_triggered {
	meta: description = "Rule # 840 Suspicious String T1KUS90T triggered"
	strings: $suspicious_string = "T1KUS90T"
	condition: $suspicious_string
}
rule Rule_841_triggered {
	meta: description = "Rule # 841 Suspicious String TC9A16C47DA8EEE87 triggered"
	strings: $suspicious_string = "TC9A16C47DA8EEE87"
	condition: $suspicious_string
}
rule Rule_842_triggered {
	meta: description = "Rule # 842 Suspicious String THA Disastar triggered"
	strings: $suspicious_string = "THA Disastar"
	condition: $suspicious_string
}
rule Rule_843_triggered {
	meta: description = "Rule # 843 Suspicious String TKJ Cyber Art triggered"
	strings: $suspicious_string = "TKJ Cyber Art"
	condition: $suspicious_string
}
rule Rule_844_triggered {
	meta: description = "Rule # 844 Suspicious String TOBILOBA triggered"
	strings: $suspicious_string = "TOBILOBA"
	condition: $suspicious_string
}
rule Rule_845_triggered {
	meta: description = "Rule # 845 Suspicious String Tak Ada Kata triggered"
	strings: $suspicious_string = "Tak Ada Kata"
	condition: $suspicious_string
}
rule Rule_846_triggered {
	meta: description = "Rule # 846 Suspicious String TanpaNama404  triggered"
	strings: $suspicious_string = "TanpaNama404 "
	condition: $suspicious_string
}
rule Rule_847_triggered {
	meta: description = "Rule # 847 Suspicious String Tapi Selebihnya triggered"
	strings: $suspicious_string = "Tapi Selebihnya"
	condition: $suspicious_string
}
rule Rule_848_triggered {
	meta: description = "Rule # 848 Suspicious String Tata ReZulT triggered"
	strings: $suspicious_string = "Tata ReZulT"
	condition: $suspicious_string
}
rule Rule_849_triggered {
	meta: description = "Rule # 849 Suspicious String Tatsumi Crew triggered"
	strings: $suspicious_string = "Tatsumi Crew"
	condition: $suspicious_string
}
rule Rule_850_triggered {
	meta: description = "Rule # 850 Suspicious String Tchix triggered"
	strings: $suspicious_string = "Tchix"
	condition: $suspicious_string
}
rule Rule_851_triggered {
	meta: description = "Rule # 851 Suspicious String TeaM HacKer EgypT triggered"
	strings: $suspicious_string = "TeaM HacKer EgypT"
	condition: $suspicious_string
}
rule Rule_852_triggered {
	meta: description = "Rule # 852 Suspicious String TeaM System Dz triggered"
	strings: $suspicious_string = "TeaM System Dz"
	condition: $suspicious_string
}
rule Rule_853_triggered {
	meta: description = "Rule # 853 Suspicious String Team Arena triggered"
	strings: $suspicious_string = "Team Arena"
	condition: $suspicious_string
}
rule Rule_854_triggered {
	meta: description = "Rule # 854 Suspicious String Team BlackLeets triggered"
	strings: $suspicious_string = "Team BlackLeets"
	condition: $suspicious_string
}
rule Rule_855_triggered {
	meta: description = "Rule # 855 Suspicious String Team IndiShell triggered"
	strings: $suspicious_string = "Team IndiShell"
	condition: $suspicious_string
}
rule Rule_856_triggered {
	meta: description = "Rule # 856 Suspicious String Team_CC triggered"
	strings: $suspicious_string = "Team_CC"
	condition: $suspicious_string
}
rule Rule_857_triggered {
	meta: description = "Rule # 857 Suspicious String Teamp0ison triggered"
	strings: $suspicious_string = "Teamp0ison"
	condition: $suspicious_string
}
rule Rule_858_triggered {
	meta: description = "Rule # 858 Suspicious String Tersakti triggered"
	strings: $suspicious_string = "Tersakti"
	condition: $suspicious_string
}
rule Rule_859_triggered {
	meta: description = "Rule # 859 Suspicious String Th3 D3str0yer triggered"
	strings: $suspicious_string = "Th3 D3str0yer"
	condition: $suspicious_string
}
rule Rule_860_triggered {
	meta: description = "Rule # 860 Suspicious String Th3 K!LL3r Dz triggered"
	strings: $suspicious_string = "Th3 K!LL3r Dz"
	condition: $suspicious_string
}
rule Rule_861_triggered {
	meta: description = "Rule # 861 Suspicious String Th3 K!ng Scam triggered"
	strings: $suspicious_string = "Th3 K!ng Scam"
	condition: $suspicious_string
}
rule Rule_862_triggered {
	meta: description = "Rule # 862 Suspicious String Thanks Buat Yg Udh Support Buat Shell Ini triggered"
	strings: $suspicious_string = "Thanks Buat Yg Udh Support Buat Shell Ini"
	condition: $suspicious_string
}
rule Rule_863_triggered {
	meta: description = "Rule # 863 Suspicious String Thanks To Brothers V!rus YassCom triggered"
	strings: $suspicious_string = "Thanks To Brothers V!rus YassCom"
	condition: $suspicious_string
}
rule Rule_864_triggered {
	meta: description = "Rule # 864 Suspicious String Thats Good lemme try triggered"
	strings: $suspicious_string = "Thats Good lemme try"
	condition: $suspicious_string
}
rule Rule_865_triggered {
	meta: description = "Rule # 865 Suspicious String The Cyber Heroez White-Hat Crew triggered"
	strings: $suspicious_string = "The Cyber Heroez White-Hat Crew"
	condition: $suspicious_string
}
rule Rule_866_triggered {
	meta: description = "Rule # 866 Suspicious String The Next JanCox Shell triggered"
	strings: $suspicious_string = "The Next JanCox Shell"
	condition: $suspicious_string
}
rule Rule_867_triggered {
	meta: description = "Rule # 867 Suspicious String The Scam is 100% Clean Undetected Forever triggered"
	strings: $suspicious_string = "The Scam is 100% Clean Undetected Forever"
	condition: $suspicious_string
}
rule Rule_868_triggered {
	meta: description = "Rule # 868 Suspicious String The file you want Downloadable was nonexistent triggered"
	strings: $suspicious_string = "The file you want Downloadable was nonexistent"
	condition: $suspicious_string
}
rule Rule_869_triggered {
	meta: description = "Rule # 869 Suspicious String The r600 mailer has finished his job triggered"
	strings: $suspicious_string = "The r600 mailer has finished his job"
	condition: $suspicious_string
}
rule Rule_870_triggered {
	meta: description = "Rule # 870 Suspicious String TheChozen triggered"
	strings: $suspicious_string = "TheChozen"
	condition: $suspicious_string
}
rule Rule_871_triggered {
	meta: description = "Rule # 871 Suspicious String TheLords triggered"
	strings: $suspicious_string = "TheLords"
	condition: $suspicious_string
}
rule Rule_872_triggered {
	meta: description = "Rule # 872 Suspicious String Tn-ViRus triggered"
	strings: $suspicious_string = "Tn-ViRus"
	condition: $suspicious_string
}
rule Rule_873_triggered {
	meta: description = "Rule # 873 Suspicious String Tn.SkullCyber triggered"
	strings: $suspicious_string = "Tn.SkullCyber"
	condition: $suspicious_string
}
rule Rule_874_triggered {
	meta: description = "Rule # 874 Suspicious String To known the password, you must first send triggered"
	strings: $suspicious_string = "To known the password, you must first send"
	condition: $suspicious_string
}
rule Rule_875_triggered {
	meta: description = "Rule # 875 Suspicious String TobaSec triggered"
...
rule Rule_877_triggered {
	meta: description = "Rule # 877 Suspicious String Tools Carder triggered"
	strings: $suspicious_string = "Tools Carder"
	condition: $suspicious_string
}
rule Rule_878_triggered {
	meta: description = "Rule # 878 Suspicious String Toxica DZ Was Here triggered"
	strings: $suspicious_string = "Toxica DZ Was Here"
	condition: $suspicious_string
}
rule Rule_879_triggered {
	meta: description = "Rule # 879 Suspicious String TrYaG triggered"
	strings: $suspicious_string = "TrYaG"
	condition: $suspicious_string
}
rule Rule_880_triggered {
	meta: description = "Rule # 880 Suspicious String Trickster triggered"
	strings: $suspicious_string = "Trickster"
	condition: $suspicious_string
}
rule Rule_881_triggered {
	meta: description = "Rule # 881 Suspicious String Triple A triggered"
	strings: $suspicious_string = "Triple A"
	condition: $suspicious_string
}
rule Rule_882_triggered {
	meta: description = "Rule # 882 Suspicious String True Login (via cURL) Scams triggered"
	strings: $suspicious_string = "True Login (via cURL) Scams"
	condition: $suspicious_string
}
rule Rule_883_triggered {
	meta: description = "Rule # 883 Suspicious String Tryag File Manager triggered"
	strings: $suspicious_string = "Tryag File Manager"
	condition: $suspicious_string
}
rule Rule_884_triggered {
	meta: description = "Rule # 884 Suspicious String Tu5b0l3d triggered"
...
rule Rule_886_triggered {
	meta: description = "Rule # 886 Suspicious String Tuan_galau  triggered"
	strings: $suspicious_string = "Tuan_galau "
	condition: $suspicious_string
}
rule Rule_887_triggered {
	meta: description = "Rule # 887 Suspicious String Tunisian HaCker triggered"
	strings: $suspicious_string = "Tunisian HaCker"
	condition: $suspicious_string
}
rule Rule_888_triggered {
	meta: description = "Rule # 888 Suspicious String Turbo Force By TrYaG.CC triggered"
	strings: $suspicious_string = "Turbo Force By TrYaG.CC"
	condition: $suspicious_string
}
rule Rule_889_triggered {
	meta: description = "Rule # 889 Suspicious String Tuyul Gaul Team  triggered"
	strings: $suspicious_string = "Tuyul Gaul Team "
	condition: $suspicious_string
}
rule Rule_890_triggered {
	meta: description = "Rule # 890 Suspicious String T�x�� Ph��t�m triggered"
	strings: $suspicious_string = "T�x�� Ph��t�m"
	condition: $suspicious_string
}
rule Rule_891_triggered {
	meta: description = "Rule # 891 Suspicious String U7TiM4T3 H4x0R triggered"
	strings: $suspicious_string = "U7TiM4T3 H4x0R"
	condition: $suspicious_string
}
rule Rule_892_triggered {
	meta: description = "Rule # 892 Suspicious String UDP DDoSing triggered"
	strings: $suspicious_string = "UDP DDoSing"
	condition: $suspicious_string
}
rule Rule_893_triggered {
	meta: description = "Rule # 893 Suspicious String UNDERGROUND HACKERS triggered"
	strings: $suspicious_string = "UNDERGROUND HACKERS"
	condition: $suspicious_string
}
rule Rule_894_triggered {
	meta: description = "Rule # 894 Suspicious String UP=\"pentagon\" triggered"
	strings: $suspicious_string = "UP=\"pentagon\""
	condition: $suspicious_string
}
rule Rule_895_triggered {
	meta: description = "Rule # 895 Suspicious String United Bangladeshi Hackers triggered"
	strings: $suspicious_string = "United Bangladeshi Hackers"
	condition: $suspicious_string
}
rule Rule_896_triggered {
	meta: description = "Rule # 896 Suspicious String UnkCrew triggered"
	strings: $suspicious_string = "UnkCrew"
	condition: $suspicious_string
}
rule Rule_897_triggered {
	meta: description = "Rule # 897 Suspicious String Upl04d3r triggered"
	strings: $suspicious_string = "Upl04d3r"
	condition: $suspicious_string
}
rule Rule_898_triggered {
	meta: description = "Rule # 898 Suspicious String Upload Fail !!! triggered"
	strings: $suspicious_string = "Upload Fail !!!"
	condition: $suspicious_string
}
rule Rule_899_triggered {
	meta: description = "Rule # 899 Suspicious String Upload Shell Korang triggered"
	strings: $suspicious_string = "Upload Shell Korang"
	condition: $suspicious_string
}
rule Rule_900_triggered {
	meta: description = "Rule # 900 Suspicious String Upload Success !!! triggered"
	strings: $suspicious_string = "Upload Success !!!"
	condition: $suspicious_string
}
rule Rule_901_triggered {
	meta: description = "Rule # 901 Suspicious String Uploader By Psyco! triggered"
	strings: $suspicious_string = "Uploader By Psyco!"
	condition: $suspicious_string
}
rule Rule_902_triggered {
	meta: description = "Rule # 902 Suspicious String Use this function to check in witch domain zones user comes triggered"
	strings: $suspicious_string = "Use this function to check in witch domain zones user comes"
	condition: $suspicious_string
}
rule Rule_903_triggered {
	meta: description = "Rule # 903 Suspicious String UseYourBrain triggered"
	strings: $suspicious_string = "UseYourBrain"
	condition: $suspicious_string
}
rule Rule_904_triggered {
	meta: description = "Rule # 904 Suspicious String UseYourDream triggered"
	strings: $suspicious_string = "UseYourDream"
	condition: $suspicious_string
}
rule Rule_905_triggered {
	meta: description = "Rule # 905 Suspicious String V3rluchie triggered"
	strings: $suspicious_string = "V3rluchie"
	condition: $suspicious_string
}
rule Rule_906_triggered {
	meta: description = "Rule # 906 Suspicious String VERSION mIRC version by LaNTaK GaNTeNG triggered"
	strings: $suspicious_string = "VERSION mIRC version by LaNTaK GaNTeNG"
	condition: $suspicious_string
}
rule Rule_907_triggered {
	meta: description = "Rule # 907 Suspicious String VIRUSX triggered"
	strings: $suspicious_string = "VIRUSX"
	condition: $suspicious_string
}
rule Rule_908_triggered {
	meta: description = "Rule # 908 Suspicious String VISA_DYALNA triggered"
	strings: $suspicious_string = "VISA_DYALNA"
	condition: $suspicious_string
}
rule Rule_909_triggered {
	meta: description = "Rule # 909 Suspicious String VNC ScaNNer by ARZ triggered"
	strings: $suspicious_string = "VNC ScaNNer by ARZ"
	condition: $suspicious_string
}
rule Rule_910_triggered {
	meta: description = "Rule # 910 Suspicious String ViKi  triggered"
	strings: $suspicious_string = "ViKi "
	condition: $suspicious_string
}
rule Rule_911_triggered {
	meta: description = "Rule # 911 Suspicious String ViRuS702 triggered"
	strings: $suspicious_string = "ViRuS702"
	condition: $suspicious_string
}
rule Rule_912_triggered {
	meta: description = "Rule # 912 Suspicious String ViRusx triggered"
	strings: $suspicious_string = "ViRusx"
	condition: $suspicious_string
}
rule Rule_913_triggered {
	meta: description = "Rule # 913 Suspicious String Virusa Worm triggered"
	strings: $suspicious_string = "Virusa Worm"
	condition: $suspicious_string
}
rule Rule_914_triggered {
	meta: description = "Rule # 914 Suspicious String VrCy     triggered"
...
rule Rule_916_triggered {
	meta: description = "Rule # 916 Suspicious String Vurdum mu Samari Oynar Gotunun Damari triggered"
	strings: $suspicious_string = "Vurdum mu Samari Oynar Gotunun Damari"
	condition: $suspicious_string
}
rule Rule_917_triggered {
	meta: description = "Rule # 917 Suspicious String W1R3 triggered"
	strings: $suspicious_string = "W1R3"
	condition: $suspicious_string
}
rule Rule_918_triggered {
	meta: description = "Rule # 918 Suspicious String W3lc0m3 M4st3r triggered"
	strings: $suspicious_string = "W3lc0m3 M4st3r"
	condition: $suspicious_string
}
rule Rule_919_triggered {
	meta: description = "Rule # 919 Suspicious String WHIT3 DR4G0N triggered"
	strings: $suspicious_string = "WHIT3 DR4G0N"
	condition: $suspicious_string
}
rule Rule_920_triggered {
	meta: description = "Rule # 920 Suspicious String WHMCS KILLER V3 CODED BY RAB3OUN triggered"
	strings: $suspicious_string = "WHMCS KILLER V3 CODED BY RAB3OUN"
	condition: $suspicious_string
}
rule Rule_921_triggered {
	meta: description = "Rule # 921 Suspicious String WHMCS Killer v3 Decoded By N!nj@ triggered"
	strings: $suspicious_string = "WHMCS Killer v3 Decoded By N!nj@"
	condition: $suspicious_string
}
rule Rule_922_triggered {
	meta: description = "Rule # 922 Suspicious String WORK HARD DREAM B!G triggered"
	strings: $suspicious_string = "WORK HARD DREAM B!G"
	condition: $suspicious_string
}
rule Rule_923_triggered {
	meta: description = "Rule # 923 Suspicious String WSO 2.1.5 triggered"
	strings: $suspicious_string = "WSO 2.1.5"
	condition: $suspicious_string
}
rule Rule_924_triggered {
	meta: description = "Rule # 924 Suspicious String WSO [2.6] triggered"
	strings: $suspicious_string = "WSO [2.6]"
	condition: $suspicious_string
}
rule Rule_925_triggered {
	meta: description = "Rule # 925 Suspicious String WSO r3coded by eX-Sh1Ne triggered"
	strings: $suspicious_string = "WSO r3coded by eX-Sh1Ne"
	condition: $suspicious_string
}
rule Rule_926_triggered {
	meta: description = "Rule # 926 Suspicious String WSOsetcookie triggered"
	strings: $suspicious_string = "WSOsetcookie"
	condition: $suspicious_string
}
rule Rule_927_triggered {
	meta: description = "Rule # 927 Suspicious String WScript.Shell triggered"
	strings: $suspicious_string = "WScript.Shell"
	condition: $suspicious_string
}
rule Rule_928_triggered {
	meta: description = "Rule # 928 Suspicious String Wa7sh Hacker triggered"
	strings: $suspicious_string = "Wa7sh Hacker"
	condition: $suspicious_string
}
rule Rule_929_triggered {
	meta: description = "Rule # 929 Suspicious String Walid Curva Nord triggered"
	strings: $suspicious_string = "Walid Curva Nord"
	condition: $suspicious_string
}
rule Rule_930_triggered {
	meta: description = "Rule # 930 Suspicious String Wayaw triggered"
	strings: $suspicious_string = "Wayaw"
	condition: $suspicious_string
}
rule Rule_931_triggered {
	meta: description = "Rule # 931 Suspicious String We Are Anonymous triggered"
	strings: $suspicious_string = "We Are Anonymous"
	condition: $suspicious_string
}
rule Rule_932_triggered {
	meta: description = "Rule # 932 Suspicious String We Are Bangladeshi Hacker triggered"
	strings: $suspicious_string = "We Are Bangladeshi Hacker"
	condition: $suspicious_string
}
rule Rule_933_triggered {
	meta: description = "Rule # 933 Suspicious String We Are Legion triggered"
	strings: $suspicious_string = "We Are Legion"
	condition: $suspicious_string
}
rule Rule_934_triggered {
	meta: description = "Rule # 934 Suspicious String We Are Royal Battler BD triggered"
	strings: $suspicious_string = "We Are Royal Battler BD"
	condition: $suspicious_string
}
rule Rule_935_triggered {
	meta: description = "Rule # 935 Suspicious String We Do not Forget triggered"
	strings: $suspicious_string = "We Do not Forget"
	condition: $suspicious_string
}
rule Rule_936_triggered {
	meta: description = "Rule # 936 Suspicious String We Do not Forgiv triggered"
	strings: $suspicious_string = "We Do not Forgiv"
	condition: $suspicious_string
}
rule Rule_937_triggered {
	meta: description = "Rule # 937 Suspicious String We aRe International Muslim Hacker Team triggered"
	strings: $suspicious_string = "We aRe International Muslim Hacker Team"
	condition: $suspicious_string
}
rule Rule_938_triggered {
	meta: description = "Rule # 938 Suspicious String We are Anonymous triggered"
	strings: $suspicious_string = "We are Anonymous"
	condition: $suspicious_string
}
rule Rule_939_triggered {
	meta: description = "Rule # 939 Suspicious String We are Legion triggered"
	strings: $suspicious_string = "We are Legion"
	condition: $suspicious_string
}
rule Rule_940_triggered {
	meta: description = "Rule # 940 Suspicious String We do not Forget triggered"
	strings: $suspicious_string = "We do not Forget"
	condition: $suspicious_string
}
rule Rule_941_triggered {
	meta: description = "Rule # 941 Suspicious String We do not Forgive triggered"
	strings: $suspicious_string = "We do not Forgive"
	condition: $suspicious_string
}
rule Rule_942_triggered {
	meta: description = "Rule # 942 Suspicious String We make your security better by breaking it triggered"
	strings: $suspicious_string = "We make your security better by breaking it"
	condition: $suspicious_string
}
rule Rule_943_triggered {
	meta: description = "Rule # 943 Suspicious String We only wanna Mine triggered"
	strings: $suspicious_string = "We only wanna Mine"
	condition: $suspicious_string
}
rule Rule_944_triggered {
	meta: description = "Rule # 944 Suspicious String We will return as our ancestors did triggered"
	strings: $suspicious_string = "We will return as our ancestors did"
	condition: $suspicious_string
}
rule Rule_945_triggered {
	meta: description = "Rule # 945 Suspicious String Web Shell triggered"
	strings: $suspicious_string = "Web Shell"
	condition: $suspicious_string
}
rule Rule_946_triggered {
	meta: description = "Rule # 946 Suspicious String Web Shell by HARD _LINUX triggered"
	strings: $suspicious_string = "Web Shell by HARD _LINUX"
	condition: $suspicious_string
}
rule Rule_947_triggered {
	meta: description = "Rule # 947 Suspicious String WebShellOrb 2.6 - With PHP 7 triggered"
	strings: $suspicious_string = "WebShellOrb 2.6 - With PHP 7"
	condition: $suspicious_string
}
rule Rule_948_triggered {
	meta: description = "Rule # 948 Suspicious String Webmail Of Sellers triggered"
	strings: $suspicious_string = "Webmail Of Sellers"
	condition: $suspicious_string
}
rule Rule_949_triggered {
	meta: description = "Rule # 949 Suspicious String Webshell triggered"
	strings: $suspicious_string = "Webshell"
	condition: $suspicious_string
}
rule Rule_950_triggered {
	meta: description = "Rule # 950 Suspicious String WellsFargo Login Result triggered"
	strings: $suspicious_string = "WellsFargo Login Result"
	condition: $suspicious_string
}
rule Rule_951_triggered {
	meta: description = "Rule # 951 Suspicious String What is your favourite plac? triggered"
	strings: $suspicious_string = "What is your favourite plac?"
	condition: $suspicious_string
}
rule Rule_952_triggered {
	meta: description = "Rule # 952 Suspicious String Whcms Killer triggered"
	strings: $suspicious_string = "Whcms Killer"
	condition: $suspicious_string
}
rule Rule_953_triggered {
	meta: description = "Rule # 953 Suspicious String WordPress Auto Deface triggered"
	strings: $suspicious_string = "WordPress Auto Deface"
	condition: $suspicious_string
}
rule Rule_954_triggered {
	meta: description = "Rule # 954 Suspicious String Wordpress Csrf Exploit triggered"
	strings: $suspicious_string = "Wordpress Csrf Exploit"
	condition: $suspicious_string
}
rule Rule_955_triggered {
	meta: description = "Rule # 955 Suspicious String Wr0nG P4sSw0rD triggered"
	strings: $suspicious_string = "Wr0nG P4sSw0rD"
	condition: $suspicious_string
}
rule Rule_956_triggered {
	meta: description = "Rule # 956 Suspicious String Wscript.Shell triggered"
	strings: $suspicious_string = "Wscript.Shell"
	condition: $suspicious_string
}
rule Rule_957_triggered {
	meta: description = "Rule # 957 Suspicious String Wso1 SHELL triggered"
	strings: $suspicious_string = "Wso1 SHELL"
	condition: $suspicious_string
}
rule Rule_958_triggered {
	meta: description = "Rule # 958 Suspicious String WwW.Gaza-Hacker.NeT triggered"
	strings: $suspicious_string = "WwW.Gaza-Hacker.NeT"
	condition: $suspicious_string
}
rule Rule_959_triggered {
	meta: description = "Rule # 959 Suspicious String WwW.SeCuReDeAtH.cOm triggered"
	strings: $suspicious_string = "WwW.SeCuReDeAtH.cOm"
	condition: $suspicious_string
}
rule Rule_960_triggered {
	meta: description = "Rule # 960 Suspicious String X Attacker triggered"
	strings: $suspicious_string = "X Attacker"
	condition: $suspicious_string
}
rule Rule_961_triggered {
	meta: description = "Rule # 961 Suspicious String X-Blackerz INC. triggered"
	strings: $suspicious_string = "X-Blackerz INC."
	condition: $suspicious_string
}
rule Rule_962_triggered {
	meta: description = "Rule # 962 Suspicious String X-GHOST MA triggered"
	strings: $suspicious_string = "X-GHOST MA"
	condition: $suspicious_string
}
rule Rule_963_triggered {
	meta: description = "Rule # 963 Suspicious String X-Sn!p3r_P4l triggered"
	strings: $suspicious_string = "X-Sn!p3r_P4l"
	condition: $suspicious_string
}
rule Rule_964_triggered {
	meta: description = "Rule # 964 Suspicious String X-Wjdy triggered"
	strings: $suspicious_string = "X-Wjdy"
	condition: $suspicious_string
}
rule Rule_965_triggered {
	meta: description = "Rule # 965 Suspicious String X-Wu7z  triggered"
	strings: $suspicious_string = "X-Wu7z "
	condition: $suspicious_string
}
rule Rule_966_triggered {
	meta: description = "Rule # 966 Suspicious String X0blank@yahoo.com triggered"
	strings: $suspicious_string = "X0blank@yahoo.com"
	condition: $suspicious_string
}
rule Rule_967_triggered {
	meta: description = "Rule # 967 Suspicious String X3VzZXJfYWJ triggered"
	strings: $suspicious_string = "X3VzZXJfYWJ"
	condition: $suspicious_string
}
rule Rule_968_triggered {
	meta: description = "Rule # 968 Suspicious String XMRig triggered"
	strings: $suspicious_string = "XMRig"
	condition: $suspicious_string
}
rule Rule_969_triggered {
	meta: description = "Rule # 969 Suspicious String XXX~HACKER TEAM triggered"
	strings: $suspicious_string = "XXX~HACKER TEAM"
	condition: $suspicious_string
}
rule Rule_970_triggered {
	meta: description = "Rule # 970 Suspicious String XXX~HACKER TEAM WAS HERE triggered"
	strings: $suspicious_string = "XXX~HACKER TEAM WAS HERE"
	condition: $suspicious_string
}
rule Rule_971_triggered {
	meta: description = "Rule # 971 Suspicious String X_0 triggered"
	strings: $suspicious_string = "X_0"
	condition: $suspicious_string
}
rule Rule_972_triggered {
	meta: description = "Rule # 972 Suspicious String XaiSyndicate triggered"
	strings: $suspicious_string = "XaiSyndicate"
	condition: $suspicious_string
}
rule Rule_973_triggered {
	meta: description = "Rule # 973 Suspicious String Xalvadela  triggered"
	strings: $suspicious_string = "Xalvadela "
	condition: $suspicious_string
}
rule Rule_974_triggered {
	meta: description = "Rule # 974 Suspicious String Xaveroz_Tersakiti triggered"
...
rule Rule_976_triggered {
	meta: description = "Rule # 976 Suspicious String Xclusiv-3D-Logs triggered"
	strings: $suspicious_string = "Xclusiv-3D-Logs"
	condition: $suspicious_string
}
rule Rule_977_triggered {
	meta: description = "Rule # 977 Suspicious String XnonGremX triggered"
	strings: $suspicious_string = "XnonGremX"
	condition: $suspicious_string
}
rule Rule_978_triggered {
	meta: description = "Rule # 978 Suspicious String YAHOO 2015 triggered"
	strings: $suspicious_string = "YAHOO 2015"
	condition: $suspicious_string
}
rule Rule_979_triggered {
	meta: description = "Rule # 979 Suspicious String YAHOO.membership triggered"
	strings: $suspicious_string = "YAHOO.membership"
	condition: $suspicious_string
}
rule Rule_980_triggered {
	meta: description = "Rule # 980 Suspicious String YASSINOX CONFIG FUCKER triggered"
	strings: $suspicious_string = "YASSINOX CONFIG FUCKER"
	condition: $suspicious_string
}
rule Rule_981_triggered {
	meta: description = "Rule # 981 Suspicious String YaNaL-x Jo triggered"
	strings: $suspicious_string = "YaNaL-x Jo"
	condition: $suspicious_string
}
rule Rule_982_triggered {
	meta: description = "Rule # 982 Suspicious String YaSser Ma triggered"
	strings: $suspicious_string = "YaSser Ma"
	condition: $suspicious_string
}
rule Rule_983_triggered {
	meta: description = "Rule # 983 Suspicious String Yash triggered"
	strings: $suspicious_string = "Yash"
	condition: $suspicious_string
}
rule Rule_984_triggered {
	meta: description = "Rule # 984 Suspicious String Yazilimlar SHELL triggered"
	strings: $suspicious_string = "Yazilimlar SHELL"
	condition: $suspicious_string
}
rule Rule_985_triggered {
	meta: description = "Rule # 985 Suspicious String YeMeNi HaCkeR triggered"
	strings: $suspicious_string = "YeMeNi HaCkeR"
	condition: $suspicious_string
}
rule Rule_986_triggered {
	meta: description = "Rule # 986 Suspicious String Yet Another Miner by yvg1900 triggered"
	strings: $suspicious_string = "Yet Another Miner by yvg1900"
	condition: $suspicious_string
}
rule Rule_987_triggered {
	meta: description = "Rule # 987 Suspicious String You Security is very low triggered"
	strings: $suspicious_string = "You Security is very low"
	condition: $suspicious_string
}
rule Rule_988_triggered {
	meta: description = "Rule # 988 Suspicious String Your WebSite Got Boxed triggered"
	strings: $suspicious_string = "Your WebSite Got Boxed"
	condition: $suspicious_string
}
rule Rule_989_triggered {
	meta: description = "Rule # 989 Suspicious String Your data are encrypted triggered"
	strings: $suspicious_string = "Your data are encrypted"
	condition: $suspicious_string
}
rule Rule_990_triggered {
	meta: description = "Rule # 990 Suspicious String Yrid06  triggered"
	strings: $suspicious_string = "Yrid06 "
	condition: $suspicious_string
}
rule Rule_991_triggered {
	meta: description = "Rule # 991 Suspicious String ZETHA WEB SHELL triggered"
	strings: $suspicious_string = "ZETHA WEB SHELL"
	condition: $suspicious_string
}
rule Rule_992_triggered {
	meta: description = "Rule # 992 Suspicious String ZONE-H triggered"
	strings: $suspicious_string = "ZONE-H"
	condition: $suspicious_string
}
rule Rule_993_triggered {
	meta: description = "Rule # 993 Suspicious String ZWNobyAiPGI+Ii5waHBfdW5hbWUoKS4iPC9iPiI7IA0KZWNobyAiPGJy triggered"
	strings: $suspicious_string = "ZWNobyAiPGI+Ii5waHBfdW5hbWUoKS4iPC9iPiI7IA0KZWNobyAiPGJy"
	condition: $suspicious_string
}
rule Rule_994_triggered {
	meta: description = "Rule # 994 Suspicious String ZXJyb3JfcmVwb3J0aW5nKDApO triggered"
	strings: $suspicious_string = "ZXJyb3JfcmVwb3J0aW5nKDApO"
	condition: $suspicious_string
}
rule Rule_995_triggered {
	meta: description = "Rule # 995 Suspicious String ZakirDotId triggered"
	strings: $suspicious_string = "ZakirDotId"
	condition: $suspicious_string
}
rule Rule_996_triggered {
	meta: description = "Rule # 996 Suspicious String Zar0us triggered"
	strings: $suspicious_string = "Zar0us"
	condition: $suspicious_string
}
rule Rule_997_triggered {
	meta: description = "Rule # 997 Suspicious String ZeroBy7es triggered"
	strings: $suspicious_string = "ZeroBy7es"
	condition: $suspicious_string
}
rule Rule_998_triggered {
	meta: description = "Rule # 998 Suspicious String Zero_S triggered"
	strings: $suspicious_string = "Zero_S"
	condition: $suspicious_string
}
rule Rule_999_triggered {
	meta: description = "Rule # 999 Suspicious String Zetas Oujdi triggered"
	strings: $suspicious_string = "Zetas Oujdi"
	condition: $suspicious_string
}
rule Rule_1000_triggered {
	meta: description = "Rule # 1000 Suspicious String ZoRRoKiN triggered"
	strings: $suspicious_string = "ZoRRoKiN"
	condition: $suspicious_string
}
rule Rule_1001_triggered {
	meta: description = "Rule # 1001 Suspicious String Zone-H triggered"
	strings: $suspicious_string = "Zone-H"
	condition: $suspicious_string
}
rule Rule_1002_triggered {
	meta: description = "Rule # 1002 Suspicious String Zz3ro CooL triggered"
	strings: $suspicious_string = "Zz3ro CooL"
	condition: $suspicious_string
}
rule Rule_1003_triggered {
	meta: description = "Rule # 1003 Suspicious String [+] Founded  triggered"
	strings: $suspicious_string = "[+] Founded "
	condition: $suspicious_string
}
rule Rule_1004_triggered {
	meta: description = "Rule # 1004 Suspicious String _0xaae8 triggered"
	strings: $suspicious_string = "_0xaae8"
	condition: $suspicious_string
}
rule Rule_1005_triggered {
	meta: description = "Rule # 1005 Suspicious String _68758598 triggered"
	strings: $suspicious_string = "_68758598"
	condition: $suspicious_string
}
rule Rule_1006_triggered {
	meta: description = "Rule # 1006 Suspicious String _Tuan2Fay_  triggered"
	strings: $suspicious_string = "_Tuan2Fay_ "
	condition: $suspicious_string
}
rule Rule_1007_triggered {
	meta: description = "Rule # 1007 Suspicious String a8ab0 triggered"
	strings: $suspicious_string = "a8ab0"
	condition: $suspicious_string
}
rule Rule_1008_triggered {
	meta: description = "Rule # 1008 Suspicious String aBu.HaLiL501 triggered"
	strings: $suspicious_string = "aBu.HaLiL501"
	condition: $suspicious_string
}
rule Rule_1009_triggered {
	meta: description = "Rule # 1009 Suspicious String aWYgKGlzc2V0KCRfUkVRVUVTVFsnc triggered"
	strings: $suspicious_string = "aWYgKGlzc2V0KCRfUkVRVUVTVFsnc"
	condition: $suspicious_string
}
rule Rule_1010_triggered {
	meta: description = "Rule # 1010 Suspicious String ada data yang kosong triggered"
	strings: $suspicious_string = "ada data yang kosong"
	condition: $suspicious_string
}
rule Rule_1011_triggered {
	meta: description = "Rule # 1011 Suspicious String add.francafranca.com triggered"
	strings: $suspicious_string = "add.francafranca.com"
	condition: $suspicious_string
}
rule Rule_1012_triggered {
	meta: description = "Rule # 1012 Suspicious String admin.furstoutountzi.com triggered"
	strings: $suspicious_string = "admin.furstoutountzi.com"
	condition: $suspicious_string
}
rule Rule_1013_triggered {
	meta: description = "Rule # 1013 Suspicious String adminer.php triggered"
	strings: $suspicious_string = "adminer.php"
	condition: $suspicious_string
}
rule Rule_1014_triggered {
	meta: description = "Rule # 1014 Suspicious String adorablejimalvarez@gmail.com triggered"
	strings: $suspicious_string = "adorablejimalvarez@gmail.com"
	condition: $suspicious_string
}
rule Rule_1015_triggered {
	meta: description = "Rule # 1015 Suspicious String advanced html base64 encryptor triggered"
	strings: $suspicious_string = "advanced html base64 encryptor"
	condition: $suspicious_string
}
rule Rule_1016_triggered {
	meta: description = "Rule # 1016 Suspicious String aeskoly triggered"
	strings: $suspicious_string = "aeskoly"
	condition: $suspicious_string
}
rule Rule_1017_triggered {
	meta: description = "Rule # 1017 Suspicious String afoikoko@gmail.com triggered"
	strings: $suspicious_string = "afoikoko@gmail.com"
	condition: $suspicious_string
}
rule Rule_1018_triggered {
	meta: description = "Rule # 1018 Suspicious String agileurbia.com/2ltN triggered"
	strings: $suspicious_string = "agileurbia.com/2ltN"
	condition: $suspicious_string
}
rule Rule_1019_triggered {
	meta: description = "Rule # 1019 Suspicious String ahufvcoivw triggered"
	strings: $suspicious_string = "ahufvcoivw"
	condition: $suspicious_string
}
rule Rule_1020_triggered {
	meta: description = "Rule # 1020 Suspicious String alcustomer1984@gmail.com triggered"
	strings: $suspicious_string = "alcustomer1984@gmail.com"
	condition: $suspicious_string
}
rule Rule_1021_triggered {
	meta: description = "Rule # 1021 Suspicious String alextho676@gmail.com triggered"
	strings: $suspicious_string = "alextho676@gmail.com"
	condition: $suspicious_string
}
rule Rule_1022_triggered {
	meta: description = "Rule # 1022 Suspicious String ali.lazaar22@Gmail.com triggered"
	strings: $suspicious_string = "ali.lazaar22@Gmail.com"
	condition: $suspicious_string
}
rule Rule_1023_triggered {
	meta: description = "Rule # 1023 Suspicious String alm3refh.com triggered"
	strings: $suspicious_string = "alm3refh.com"
	condition: $suspicious_string
}
rule Rule_1024_triggered {
	meta: description = "Rule # 1024 Suspicious String alonecode triggered"
	strings: $suspicious_string = "alonecode"
	condition: $suspicious_string
}
rule Rule_1025_triggered {
	meta: description = "Rule # 1025 Suspicious String alubarika4ever@gmail.com triggered"
	strings: $suspicious_string = "alubarika4ever@gmail.com"
	condition: $suspicious_string
}
rule Rule_1026_triggered {
	meta: description = "Rule # 1026 Suspicious String amazon scams triggered"
	strings: $suspicious_string = "amazon scams"
	condition: $suspicious_string
}
rule Rule_1027_triggered {
	meta: description = "Rule # 1027 Suspicious String angular.club/js/everlast.js triggered"
	strings: $suspicious_string = "angular.club/js/everlast.js"
	condition: $suspicious_string
}
rule Rule_1028_triggered {
	meta: description = "Rule # 1028 Suspicious String anjirGBX  triggered"
	strings: $suspicious_string = "anjirGBX "
	condition: $suspicious_string
}
rule Rule_1029_triggered {
	meta: description = "Rule # 1029 Suspicious String aoldocs triggered"
	strings: $suspicious_string = "aoldocs"
	condition: $suspicious_string
}
rule Rule_1030_triggered {
	meta: description = "Rule # 1030 Suspicious String ashrepetto43@gmail.com triggered"
	strings: $suspicious_string = "ashrepetto43@gmail.com"
	condition: $suspicious_string
}
rule Rule_1031_triggered {
	meta: description = "Rule # 1031 Suspicious String awertase triggered"
	strings: $suspicious_string = "awertase"
	condition: $suspicious_string
}
rule Rule_1032_triggered {
	meta: description = "Rule # 1032 Suspicious String awso shell triggered"
	strings: $suspicious_string = "awso shell"
	condition: $suspicious_string
}
rule Rule_1033_triggered {
	meta: description = "Rule # 1033 Suspicious String axabanque.fr triggered"
	strings: $suspicious_string = "axabanque.fr"
	condition: $suspicious_string
}
rule Rule_1034_triggered {
	meta: description = "Rule # 1034 Suspicious String aykutbilgic@gmail.com triggered"
	strings: $suspicious_string = "aykutbilgic@gmail.com"
	condition: $suspicious_string
}
rule Rule_1035_triggered {
	meta: description = "Rule # 1035 Suspicious String ayotomiwa11@gmail.com triggered"
	strings: $suspicious_string = "ayotomiwa11@gmail.com"
	condition: $suspicious_string
}
rule Rule_1036_triggered {
	meta: description = "Rule # 1036 Suspicious String ayoubaittoto@gmail.com triggered"
	strings: $suspicious_string = "ayoubaittoto@gmail.com"
	condition: $suspicious_string
}
rule Rule_1037_triggered {
	meta: description = "Rule # 1037 Suspicious String azzatssins.cyberserkers triggered"
	strings: $suspicious_string = "azzatssins.cyberserkers"
	condition: $suspicious_string
}
rule Rule_1038_triggered {
	meta: description = "Rule # 1038 Suspicious String b0ne triggered"
	strings: $suspicious_string = "b0ne"
	condition: $suspicious_string
}
rule Rule_1039_triggered {
	meta: description = "Rule # 1039 Suspicious String b374k 2.8 triggered"
	strings: $suspicious_string = "b374k 2.8"
	condition: $suspicious_string
}
rule Rule_1040_triggered {
	meta: description = "Rule # 1040 Suspicious String b374k-shell triggered"
	strings: $suspicious_string = "b374k-shell"
	condition: $suspicious_string
}
rule Rule_1041_triggered {
	meta: description = "Rule # 1041 Suspicious String b4che10r triggered"
	strings: $suspicious_string = "b4che10r"
	condition: $suspicious_string
}
rule Rule_1042_triggered {
	meta: description = "Rule # 1042 Suspicious String backconnect weevely triggered"
	strings: $suspicious_string = "backconnect weevely"
	condition: $suspicious_string
}
rule Rule_1043_triggered {
	meta: description = "Rule # 1043 Suspicious String badermuhamed@yahoo.com triggered"
	strings: $suspicious_string = "badermuhamed@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1044_triggered {
	meta: description = "Rule # 1044 Suspicious String badrddine777@gmail.com triggered"
	strings: $suspicious_string = "badrddine777@gmail.com"
	condition: $suspicious_string
}
rule Rule_1045_triggered {
	meta: description = "Rule # 1045 Suspicious String bangladeshblackhat triggered"
	strings: $suspicious_string = "bangladeshblackhat"
	condition: $suspicious_string
}
rule Rule_1046_triggered {
	meta: description = "Rule # 1046 Suspicious String bankofamerica.com triggered"
	strings: $suspicious_string = "bankofamerica.com"
	condition: $suspicious_string
}
rule Rule_1047_triggered {
	meta: description = "Rule # 1047 Suspicious String base64_decode(\"DQplcnJvcl9yZXBvcnRpbmcoM triggered"
	strings: $suspicious_string = "base64_decode(\"DQplcnJvcl9yZXBvcnRpbmcoM"
	condition: $suspicious_string
}
rule Rule_1048_triggered {
	meta: description = "Rule # 1048 Suspicious String bash autoroot.sh triggered"
	strings: $suspicious_string = "bash autoroot.sh"
	condition: $suspicious_string
}
rule Rule_1049_triggered {
	meta: description = "Rule # 1049 Suspicious String bash_history triggered"
	strings: $suspicious_string = "bash_history"
	condition: $suspicious_string
}
rule Rule_1050_triggered {
	meta: description = "Rule # 1050 Suspicious String bbc.wehbeconstruction.com triggered"
	strings: $suspicious_string = "bbc.wehbeconstruction.com"
	condition: $suspicious_string
}
rule Rule_1051_triggered {
	meta: description = "Rule # 1051 Suspicious String bbhhinternational triggered"
	strings: $suspicious_string = "bbhhinternational"
	condition: $suspicious_string
}
rule Rule_1052_triggered {
	meta: description = "Rule # 1052 Suspicious String bckdrprm triggered"
	strings: $suspicious_string = "bckdrprm"
	condition: $suspicious_string
}
rule Rule_1053_triggered {
	meta: description = "Rule # 1053 Suspicious String bdblackhat.net triggered"
	strings: $suspicious_string = "bdblackhat.net"
	condition: $suspicious_string
}
rule Rule_1054_triggered {
	meta: description = "Rule # 1054 Suspicious String bdhh52@gmail.com triggered"
	strings: $suspicious_string = "bdhh52@gmail.com"
	condition: $suspicious_string
}
rule Rule_1055_triggered {
	meta: description = "Rule # 1055 Suspicious String believd triggered"
	strings: $suspicious_string = "believd"
	condition: $suspicious_string
}
rule Rule_1056_triggered {
	meta: description = "Rule # 1056 Suspicious String bella_mafia_quackafella triggered"
	strings: $suspicious_string = "bella_mafia_quackafella"
	condition: $suspicious_string
}
rule Rule_1057_triggered {
	meta: description = "Rule # 1057 Suspicious String bitchx triggered"
	strings: $suspicious_string = "bitchx"
	condition: $suspicious_string
}
rule Rule_1058_triggered {
	meta: description = "Rule # 1058 Suspicious String bjqnt triggered"
	strings: $suspicious_string = "bjqnt"
	condition: $suspicious_string
}
rule Rule_1059_triggered {
	meta: description = "Rule # 1059 Suspicious String blowtime666@gmail.com triggered"
	strings: $suspicious_string = "blowtime666@gmail.com"
	condition: $suspicious_string
}
rule Rule_1060_triggered {
	meta: description = "Rule # 1060 Suspicious String bobreed085@gmail.com triggered"
	strings: $suspicious_string = "bobreed085@gmail.com"
	condition: $suspicious_string
}
rule Rule_1061_triggered {
	meta: description = "Rule # 1061 Suspicious String bomba1 triggered"
	strings: $suspicious_string = "bomba1"
	condition: $suspicious_string
}
rule Rule_1062_triggered {
	meta: description = "Rule # 1062 Suspicious String botnick triggered"
	strings: $suspicious_string = "botnick"
	condition: $suspicious_string
}
rule Rule_1063_triggered {
	meta: description = "Rule # 1063 Suspicious String brewer_armstrong@yahoo.com triggered"
	strings: $suspicious_string = "brewer_armstrong@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1064_triggered {
	meta: description = "Rule # 1064 Suspicious String btnCreditCard.paymentBtn.creditcard triggered"
	strings: $suspicious_string = "btnCreditCard.paymentBtn.creditcard"
	condition: $suspicious_string
}
rule Rule_1065_triggered {
	meta: description = "Rule # 1065 Suspicious String burayaoraya triggered"
	strings: $suspicious_string = "burayaoraya"
	condition: $suspicious_string
}
rule Rule_1066_triggered {
	meta: description = "Rule # 1066 Suspicious String by INJECTOR_MA triggered"
	strings: $suspicious_string = "by INJECTOR_MA"
	condition: $suspicious_string
}
rule Rule_1067_triggered {
	meta: description = "Rule # 1067 Suspicious String by KingSolomon triggered"
	strings: $suspicious_string = "by KingSolomon"
	condition: $suspicious_string
}
rule Rule_1068_triggered {
	meta: description = "Rule # 1068 Suspicious String by misafir triggered"
	strings: $suspicious_string = "by misafir"
	condition: $suspicious_string
}
rule Rule_1069_triggered {
	meta: description = "Rule # 1069 Suspicious String by w4l3XzY3 triggered"
	strings: $suspicious_string = "by w4l3XzY3"
	condition: $suspicious_string
}
rule Rule_1070_triggered {
	meta: description = "Rule # 1070 Suspicious String c.21-2n.com triggered"
	strings: $suspicious_string = "c.21-2n.com"
	condition: $suspicious_string
}
rule Rule_1071_triggered {
	meta: description = "Rule # 1071 Suspicious String c.21-3n.com triggered"
	strings: $suspicious_string = "c.21-3n.com"
	condition: $suspicious_string
}
rule Rule_1072_triggered {
	meta: description = "Rule # 1072 Suspicious String c.21-3n.xyz triggered"
	strings: $suspicious_string = "c.21-3n.xyz"
	condition: $suspicious_string
}
rule Rule_1073_triggered {
	meta: description = "Rule # 1073 Suspicious String c0d3d By triggered"
	strings: $suspicious_string = "c0d3d By"
	condition: $suspicious_string
}
rule Rule_1074_triggered {
	meta: description = "Rule # 1074 Suspicious String c0d3d by lionaneesh triggered"
	strings: $suspicious_string = "c0d3d by lionaneesh"
	condition: $suspicious_string
}
rule Rule_1075_triggered {
	meta: description = "Rule # 1075 Suspicious String c43760b9 triggered"
	strings: $suspicious_string = "c43760b9"
	condition: $suspicious_string
}
rule Rule_1076_triggered {
	meta: description = "Rule # 1076 Suspicious String c7ca8 triggered"
	strings: $suspicious_string = "c7ca8"
	condition: $suspicious_string
}
rule Rule_1077_triggered {
	meta: description = "Rule # 1077 Suspicious String c84c8098.com triggered"
	strings: $suspicious_string = "c84c8098.com"
	condition: $suspicious_string
}
rule Rule_1078_triggered {
	meta: description = "Rule # 1078 Suspicious String c99 triggered"
	strings: $suspicious_string = "c99"
	condition: $suspicious_string
}
rule Rule_1079_triggered {
	meta: description = "Rule # 1079 Suspicious String c99.me/base triggered"
	strings: $suspicious_string = "c99.me/base"
	condition: $suspicious_string
}
rule Rule_1080_triggered {
	meta: description = "Rule # 1080 Suspicious String c999sh_surl triggered"
	strings: $suspicious_string = "c999sh_surl"
	condition: $suspicious_string
}
rule Rule_1081_triggered {
	meta: description = "Rule # 1081 Suspicious String c9gmks5fidne triggered"
	strings: $suspicious_string = "c9gmks5fidne"
	condition: $suspicious_string
}
rule Rule_1082_triggered {
	meta: description = "Rule # 1082 Suspicious String cPanel Cracker triggered"
	strings: $suspicious_string = "cPanel Cracker"
	condition: $suspicious_string
}
rule Rule_1083_triggered {
	meta: description = "Rule # 1083 Suspicious String cPanel Finder/Cracker triggered"
	strings: $suspicious_string = "cPanel Finder/Cracker"
	condition: $suspicious_string
}
rule Rule_1084_triggered {
	meta: description = "Rule # 1084 Suspicious String callbrhy triggered"
	strings: $suspicious_string = "callbrhy"
	condition: $suspicious_string
}
rule Rule_1085_triggered {
	meta: description = "Rule # 1085 Suspicious String cardnumber: triggered"
	strings: $suspicious_string = "cardnumber:"
	condition: $suspicious_string
}
rule Rule_1086_triggered {
	meta: description = "Rule # 1086 Suspicious String cazanova.haxor@hotmail.com triggered"
	strings: $suspicious_string = "cazanova.haxor@hotmail.com"
	condition: $suspicious_string
}
rule Rule_1087_triggered {
	meta: description = "Rule # 1087 Suspicious String cazanova163 triggered"
	strings: $suspicious_string = "cazanova163"
	condition: $suspicious_string
}
rule Rule_1088_triggered {
	meta: description = "Rule # 1088 Suspicious String ccteam.ru triggered"
	strings: $suspicious_string = "ccteam.ru"
	condition: $suspicious_string
}
rule Rule_1089_triggered {
	meta: description = "Rule # 1089 Suspicious String cdn.popcash.net/pop.js triggered"
	strings: $suspicious_string = "cdn.popcash.net/pop.js"
	condition: $suspicious_string
}
rule Rule_1090_triggered {
	meta: description = "Rule # 1090 Suspicious String cdob1s triggered"
	strings: $suspicious_string = "cdob1s"
	condition: $suspicious_string
}
rule Rule_1091_triggered {
	meta: description = "Rule # 1091 Suspicious String cek Disini goblok! triggered"
	strings: $suspicious_string = "cek Disini goblok!"
	condition: $suspicious_string
}
rule Rule_1092_triggered {
	meta: description = "Rule # 1092 Suspicious String centurylink.com triggered"
	strings: $suspicious_string = "centurylink.com"
	condition: $suspicious_string
}
rule Rule_1093_triggered {
	meta: description = "Rule # 1093 Suspicious String cgitelnet triggered"
	strings: $suspicious_string = "cgitelnet"
	condition: $suspicious_string
}
rule Rule_1094_triggered {
	meta: description = "Rule # 1094 Suspicious String cha88.cn triggered"
	strings: $suspicious_string = "cha88.cn"
	condition: $suspicious_string
}
rule Rule_1095_triggered {
	meta: description = "Rule # 1095 Suspicious String changed every time so chrome & bots can't see the scam source code triggered"
	strings: $suspicious_string = "changed every time so chrome & bots can't see the scam source code"
	condition: $suspicious_string
}
rule Rule_1096_triggered {
	meta: description = "Rule # 1096 Suspicious String chase.com triggered"
	strings: $suspicious_string = "chase.com"
	condition: $suspicious_string
}
rule Rule_1097_triggered {
	meta: description = "Rule # 1097 Suspicious String chiacheng2012@gmail.com triggered"
	strings: $suspicious_string = "chiacheng2012@gmail.com"
	condition: $suspicious_string
}
rule Rule_1098_triggered {
	meta: description = "Rule # 1098 Suspicious String chinazfans@gmail.com triggered"
	strings: $suspicious_string = "chinazfans@gmail.com"
	condition: $suspicious_string
}
rule Rule_1099_triggered {
	meta: description = "Rule # 1099 Suspicious String chishijen12 triggered"
	strings: $suspicious_string = "chishijen12"
	condition: $suspicious_string
}
rule Rule_1100_triggered {
	meta: description = "Rule # 1100 Suspicious String chizzyspamm@gmail.com triggered"
	strings: $suspicious_string = "chizzyspamm@gmail.com"
	condition: $suspicious_string
}
rule Rule_1101_triggered {
	meta: description = "Rule # 1101 Suspicious String chr(112).chr(49) triggered"
	strings: $suspicious_string = "chr(112).chr(49)"
	condition: $suspicious_string
}
rule Rule_1102_triggered {
	meta: description = "Rule # 1102 Suspicious String christbb616@gmail.com triggered"
	strings: $suspicious_string = "christbb616@gmail.com"
	condition: $suspicious_string
}
rule Rule_1103_triggered {
	meta: description = "Rule # 1103 Suspicious String chukuma0000007@yahoo.com triggered"
	strings: $suspicious_string = "chukuma0000007@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1104_triggered {
	meta: description = "Rule # 1104 Suspicious String click to Extract usernames and mass symlink triggered"
	strings: $suspicious_string = "click to Extract usernames and mass symlink"
	condition: $suspicious_string
}
rule Rule_1105_triggered {
	meta: description = "Rule # 1105 Suspicious String cocuk escort triggered"
	strings: $suspicious_string = "cocuk escort"
	condition: $suspicious_string
}
rule Rule_1106_triggered {
	meta: description = "Rule # 1106 Suspicious String code breaker ica triggered"
	strings: $suspicious_string = "code breaker ica"
	condition: $suspicious_string
}
rule Rule_1107_triggered {
	meta: description = "Rule # 1107 Suspicious String coded by Fian harbas triggered"
	strings: $suspicious_string = "coded by Fian harbas"
	condition: $suspicious_string
}
rule Rule_1108_triggered {
	meta: description = "Rule # 1108 Suspicious String coinhive triggered"
	strings: $suspicious_string = "coinhive"
	condition: $suspicious_string
}
rule Rule_1109_triggered {
	meta: description = "Rule # 1109 Suspicious String cold fire hacker triggered"
	strings: $suspicious_string = "cold fire hacker"
	condition: $suspicious_string
}
rule Rule_1110_triggered {
	meta: description = "Rule # 1110 Suspicious String columbuscolumbus45@gmail.com triggered"
	strings: $suspicious_string = "columbuscolumbus45@gmail.com"
	condition: $suspicious_string
}
rule Rule_1111_triggered {
	meta: description = "Rule # 1111 Suspicious String con.pechemignon.co triggered"
	strings: $suspicious_string = "con.pechemignon.co"
	condition: $suspicious_string
}
rule Rule_1112_triggered {
	meta: description = "Rule # 1112 Suspicious String con7ext-exeuser.rhcloud.com triggered"
	strings: $suspicious_string = "con7ext-exeuser.rhcloud.com"
	condition: $suspicious_string
}
rule Rule_1113_triggered {
	meta: description = "Rule # 1113 Suspicious String config-grabber.sh triggered"
	strings: $suspicious_string = "config-grabber.sh"
	condition: $suspicious_string
}
rule Rule_1114_triggered {
	meta: description = "Rule # 1114 Suspicious String config-sniper triggered"
	strings: $suspicious_string = "config-sniper"
	condition: $suspicious_string
}
rule Rule_1115_triggered {
	meta: description = "Rule # 1115 Suspicious String connectjbmoveisok triggered"
	strings: $suspicious_string = "connectjbmoveisok"
	condition: $suspicious_string
}
rule Rule_1116_triggered {
	meta: description = "Rule # 1116 Suspicious String cool shavik<br>Ebin V Thomas triggered"
	strings: $suspicious_string = "cool shavik<br>Ebin V Thomas"
	condition: $suspicious_string
}
rule Rule_1117_triggered {
	meta: description = "Rule # 1117 Suspicious String cool toad triggered"
	strings: $suspicious_string = "cool toad"
	condition: $suspicious_string
}
rule Rule_1118_triggered {
	meta: description = "Rule # 1118 Suspicious String copy 2010, MeGo triggered"
	strings: $suspicious_string = "copy 2010, MeGo"
	condition: $suspicious_string
}
rule Rule_1119_triggered {
	meta: description = "Rule # 1119 Suspicious String cpcracker.py triggered"
	strings: $suspicious_string = "cpcracker.py"
	condition: $suspicious_string
}
rule Rule_1120_triggered {
	meta: description = "Rule # 1120 Suspicious String cr1p.blogspot.com triggered"
	strings: $suspicious_string = "cr1p.blogspot.com"
	condition: $suspicious_string
}
rule Rule_1121_triggered {
	meta: description = "Rule # 1121 Suspicious String cracktype triggered"
	strings: $suspicious_string = "cracktype"
	condition: $suspicious_string
}
rule Rule_1122_triggered {
	meta: description = "Rule # 1122 Suspicious String crax0 triggered"
	strings: $suspicious_string = "crax0"
	condition: $suspicious_string
}
rule Rule_1123_triggered {
	meta: description = "Rule # 1123 Suspicious String crkekatkek_kfkukncktkikon triggered"
	strings: $suspicious_string = "crkekatkek_kfkukncktkikon"
	condition: $suspicious_string
}
rule Rule_1124_triggered {
	meta: description = "Rule # 1124 Suspicious String crowdweed triggered"
	strings: $suspicious_string = "crowdweed"
	condition: $suspicious_string
}
rule Rule_1125_triggered {
	meta: description = "Rule # 1125 Suspicious String cryptonight triggered"
	strings: $suspicious_string = "cryptonight"
	condition: $suspicious_string
}
rule Rule_1126_triggered {
	meta: description = "Rule # 1126 Suspicious String ctcpflood triggered"
	strings: $suspicious_string = "ctcpflood"
	condition: $suspicious_string
}
rule Rule_1127_triggered {
	meta: description = "Rule # 1127 Suspicious String cwings triggered"
	strings: $suspicious_string = "cwings"
	condition: $suspicious_string
}
rule Rule_1128_triggered {
	meta: description = "Rule # 1128 Suspicious String cxib [ a.T] securityreason [ d0t] com triggered"
	strings: $suspicious_string = "cxib [ a.T] securityreason [ d0t] com"
	condition: $suspicious_string
}
rule Rule_1129_triggered {
	meta: description = "Rule # 1129 Suspicious String cyber gladiator triggered"
	strings: $suspicious_string = "cyber gladiator"
	condition: $suspicious_string
}
rule Rule_1130_triggered {
	meta: description = "Rule # 1130 Suspicious String cyber warrior triggered"
	strings: $suspicious_string = "cyber warrior"
	condition: $suspicious_string
}
rule Rule_1131_triggered {
	meta: description = "Rule # 1131 Suspicious String cyberheroez.ddos.im triggered"
	strings: $suspicious_string = "cyberheroez.ddos.im"
	condition: $suspicious_string
}
rule Rule_1132_triggered {
	meta: description = "Rule # 1132 Suspicious String cydippian triggered"
	strings: $suspicious_string = "cydippian"
	condition: $suspicious_string
}
rule Rule_1133_triggered {
	meta: description = "Rule # 1133 Suspicious String czw_07  triggered"
	strings: $suspicious_string = "czw_07 "
	condition: $suspicious_string
}
rule Rule_1134_triggered {
	meta: description = "Rule # 1134 Suspicious String d.heheda.tk triggered"
	strings: $suspicious_string = "d.heheda.tk"
	condition: $suspicious_string
}
rule Rule_1135_triggered {
	meta: description = "Rule # 1135 Suspicious String d0mains triggered"
	strings: $suspicious_string = "d0mains"
	condition: $suspicious_string
}
rule Rule_1136_triggered {
	meta: description = "Rule # 1136 Suspicious String d3b~X triggered"
	strings: $suspicious_string = "d3b~X"
	condition: $suspicious_string
}
rule Rule_1137_triggered {
	meta: description = "Rule # 1137 Suspicious String dGhteXR2 triggered"
	strings: $suspicious_string = "dGhteXR2"
	condition: $suspicious_string
}
rule Rule_1138_triggered {
	meta: description = "Rule # 1138 Suspicious String dR.ArmY triggered"
	strings: $suspicious_string = "dR.ArmY"
	condition: $suspicious_string
}
rule Rule_1139_triggered {
	meta: description = "Rule # 1139 Suspicious String dalnet triggered"
	strings: $suspicious_string = "dalnet"
	condition: $suspicious_string
}
rule Rule_1140_triggered {
	meta: description = "Rule # 1140 Suspicious String dangerissaoui@outlook.com.fr triggered"
	strings: $suspicious_string = "dangerissaoui@outlook.com.fr"
	condition: $suspicious_string
}
rule Rule_1141_triggered {
	meta: description = "Rule # 1141 Suspicious String danielgrochowski1@gmail.com triggered"
	strings: $suspicious_string = "danielgrochowski1@gmail.com"
	condition: $suspicious_string
}
rule Rule_1142_triggered {
	meta: description = "Rule # 1142 Suspicious String dannymckay triggered"
	strings: $suspicious_string = "dannymckay"
	condition: $suspicious_string
}
rule Rule_1143_triggered {
	meta: description = "Rule # 1143 Suspicious String dcvi.net triggered"
	strings: $suspicious_string = "dcvi.net"
	condition: $suspicious_string
}
rule Rule_1144_triggered {
	meta: description = "Rule # 1144 Suspicious String deface triggered"
	strings: $suspicious_string = "deface"
	condition: $suspicious_string
}
rule Rule_1145_triggered {
	meta: description = "Rule # 1145 Suspicious String default pass : haurgeulis triggered"
	strings: $suspicious_string = "default pass : haurgeulis"
	condition: $suspicious_string
}
rule Rule_1146_triggered {
	meta: description = "Rule # 1146 Suspicious String dgkxjegdyzqnv triggered"
	strings: $suspicious_string = "dgkxjegdyzqnv"
	condition: $suspicious_string
}
rule Rule_1147_triggered {
	meta: description = "Rule # 1147 Suspicious String diapedesis triggered"
	strings: $suspicious_string = "diapedesis"
	condition: $suspicious_string
}
rule Rule_1148_triggered {
	meta: description = "Rule # 1148 Suspicious String die(PHP_OS.chr(49).chr(48).chr(43).md5(0987654321 triggered"
	strings: $suspicious_string = "die(PHP_OS.chr(49).chr(48).chr(43).md5(0987654321"
	condition: $suspicious_string
}
rule Rule_1149_triggered {
	meta: description = "Rule # 1149 Suspicious String dimakanhwik@gmail.com triggered"
	strings: $suspicious_string = "dimakanhwik@gmail.com"
	condition: $suspicious_string
}
rule Rule_1150_triggered {
	meta: description = "Rule # 1150 Suspicious String dirtycow triggered"
	strings: $suspicious_string = "dirtycow"
	condition: $suspicious_string
}
rule Rule_1151_triggered {
	meta: description = "Rule # 1151 Suspicious String dollypizzu37@gmail.com triggered"
	strings: $suspicious_string = "dollypizzu37@gmail.com"
	condition: $suspicious_string
}
rule Rule_1152_triggered {
	meta: description = "Rule # 1152 Suspicious String domains.yougetsignal.com triggered"
	strings: $suspicious_string = "domains.yougetsignal.com"
	condition: $suspicious_string
}
rule Rule_1153_triggered {
	meta: description = "Rule # 1153 Suspicious String donflow2015@yahoo.com triggered"
	strings: $suspicious_string = "donflow2015@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1154_triggered {
	meta: description = "Rule # 1154 Suspicious String downserverdown@gmail.com triggered"
	strings: $suspicious_string = "downserverdown@gmail.com"
	condition: $suspicious_string
}
rule Rule_1155_triggered {
	meta: description = "Rule # 1155 Suspicious String dqnxfsqvd triggered"
	strings: $suspicious_string = "dqnxfsqvd"
	condition: $suspicious_string
}
rule Rule_1156_triggered {
	meta: description = "Rule # 1156 Suspicious String dr.t3rr0r triggered"
	strings: $suspicious_string = "dr.t3rr0r"
	condition: $suspicious_string
}
rule Rule_1157_triggered {
	meta: description = "Rule # 1157 Suspicious String dropmybin.me triggered"
	strings: $suspicious_string = "dropmybin.me"
	condition: $suspicious_string
}
rule Rule_1158_triggered {
	meta: description = "Rule # 1158 Suspicious String dzph@bk.ru triggered"
	strings: $suspicious_string = "dzph@bk.ru"
	condition: $suspicious_string
}
rule Rule_1159_triggered {
	meta: description = "Rule # 1159 Suspicious String e0aae triggered"
	strings: $suspicious_string = "e0aae"
	condition: $suspicious_string
}
rule Rule_1160_triggered {
	meta: description = "Rule # 1160 Suspicious String e42d078d.com triggered"
	strings: $suspicious_string = "e42d078d.com"
	condition: $suspicious_string
}
rule Rule_1161_triggered {
	meta: description = "Rule # 1161 Suspicious String e5057bd08dc553311081fd1107f05d7a triggered"
	strings: $suspicious_string = "e5057bd08dc553311081fd1107f05d7a"
	condition: $suspicious_string
}
rule Rule_1162_triggered {
	meta: description = "Rule # 1162 Suspicious String e5b57288.com triggered"
	strings: $suspicious_string = "e5b57288.com"
	condition: $suspicious_string
}
rule Rule_1163_triggered {
	meta: description = "Rule # 1163 Suspicious String e5b57288.com|31.184.192.173 triggered"
	strings: $suspicious_string = "e5b57288.com|31.184.192.173"
	condition: $suspicious_string
}
rule Rule_1164_triggered {
	meta: description = "Rule # 1164 Suspicious String e693bc675b171a2f4ad0338d6a9b158c515295e1 triggered"
	strings: $suspicious_string = "e693bc675b171a2f4ad0338d6a9b158c515295e1"
	condition: $suspicious_string
}
rule Rule_1165_triggered {
	meta: description = "Rule # 1165 Suspicious String eIAgn9fjRC68DC7QIDhGN43qSDcw2 triggered"
	strings: $suspicious_string = "eIAgn9fjRC68DC7QIDhGN43qSDcw2"
	condition: $suspicious_string
}
rule Rule_1166_triggered {
	meta: description = "Rule # 1166 Suspicious String eM.Pr404 triggered"
	strings: $suspicious_string = "eM.Pr404"
	condition: $suspicious_string
}
rule Rule_1167_triggered {
	meta: description = "Rule # 1167 Suspicious String easywaylogs@outlook.com triggered"
	strings: $suspicious_string = "easywaylogs@outlook.com"
	condition: $suspicious_string
}
rule Rule_1168_triggered {
	meta: description = "Rule # 1168 Suspicious String ec38fe2a8497e0a8d6d349b3533038cb triggered"
	strings: $suspicious_string = "ec38fe2a8497e0a8d6d349b3533038cb"
	condition: $suspicious_string
}
rule Rule_1169_triggered {
	meta: description = "Rule # 1169 Suspicious String eelqnn@yandex.ru triggered"
	strings: $suspicious_string = "eelqnn@yandex.ru"
	condition: $suspicious_string
}
rule Rule_1170_triggered {
	meta: description = "Rule # 1170 Suspicious String eelsmarch@gmail.com triggered"
	strings: $suspicious_string = "eelsmarch@gmail.com"
	condition: $suspicious_string
}
rule Rule_1171_triggered {
	meta: description = "Rule # 1171 Suspicious String ef50185@gmail.com triggered"
	strings: $suspicious_string = "ef50185@gmail.com"
	condition: $suspicious_string
}
rule Rule_1172_triggered {
	meta: description = "Rule # 1172 Suspicious String ejykesouth@gmail.com triggered"
	strings: $suspicious_string = "ejykesouth@gmail.com"
	condition: $suspicious_string
}
rule Rule_1173_triggered {
	meta: description = "Rule # 1173 Suspicious String elcuate2339@hotmail.com triggered"
	strings: $suspicious_string = "elcuate2339@hotmail.com"
	condition: $suspicious_string
}
rule Rule_1174_triggered {
	meta: description = "Rule # 1174 Suspicious String emp3ror.com triggered"
	strings: $suspicious_string = "emp3ror.com"
	condition: $suspicious_string
}
rule Rule_1175_triggered {
	meta: description = "Rule # 1175 Suspicious String engcolinjj@gmail.com triggered"
	strings: $suspicious_string = "engcolinjj@gmail.com"
	condition: $suspicious_string
}
rule Rule_1176_triggered {
	meta: description = "Rule # 1176 Suspicious String eqzv4.resonguterthet.top triggered"
	strings: $suspicious_string = "eqzv4.resonguterthet.top"
	condition: $suspicious_string
}
rule Rule_1177_triggered {
	meta: description = "Rule # 1177 Suspicious String ethicalnoob Indishell triggered"
	strings: $suspicious_string = "ethicalnoob Indishell"
	condition: $suspicious_string
}
rule Rule_1178_triggered {
	meta: description = "Rule # 1178 Suspicious String exilibre7@gmail.com triggered"
	strings: $suspicious_string = "exilibre7@gmail.com"
	condition: $suspicious_string
}
rule Rule_1179_triggered {
	meta: description = "Rule # 1179 Suspicious String expl0i13r triggered"
	strings: $suspicious_string = "expl0i13r"
	condition: $suspicious_string
}
rule Rule_1180_triggered {
	meta: description = "Rule # 1180 Suspicious String f0300 triggered"
	strings: $suspicious_string = "f0300"
	condition: $suspicious_string
}
rule Rule_1181_triggered {
	meta: description = "Rule # 1181 Suspicious String f0x35tech@gmail.com triggered"
	strings: $suspicious_string = "f0x35tech@gmail.com"
	condition: $suspicious_string
}
rule Rule_1182_triggered {
	meta: description = "Rule # 1182 Suspicious String fake mailer triggered"
	strings: $suspicious_string = "fake mailer"
	condition: $suspicious_string
}
rule Rule_1183_triggered {
	meta: description = "Rule # 1183 Suspicious String faqux1@gmail.com triggered"
	strings: $suspicious_string = "faqux1@gmail.com"
	condition: $suspicious_string
}
rule Rule_1184_triggered {
	meta: description = "Rule # 1184 Suspicious String fedora.chen.polymet@gmail.com triggered"
	strings: $suspicious_string = "fedora.chen.polymet@gmail.com"
	condition: $suspicious_string
}
rule Rule_1185_triggered {
	meta: description = "Rule # 1185 Suspicious String fhVENcmKTJ triggered"
	strings: $suspicious_string = "fhVENcmKTJ"
	condition: $suspicious_string
}
rule Rule_1186_triggered {
	meta: description = "Rule # 1186 Suspicious String fighterkamrul562@gmail.com triggered"
	strings: $suspicious_string = "fighterkamrul562@gmail.com"
	condition: $suspicious_string
}
rule Rule_1187_triggered {
	meta: description = "Rule # 1187 Suspicious String firefart triggered"
	strings: $suspicious_string = "firefart"
	condition: $suspicious_string
}
rule Rule_1188_triggered {
	meta: description = "Rule # 1188 Suspicious String fn5c098ab854647 triggered"
	strings: $suspicious_string = "fn5c098ab854647"
	condition: $suspicious_string
}
rule Rule_1189_triggered {
	meta: description = "Rule # 1189 Suspicious String focusyearme@yahoo.com triggered"
	strings: $suspicious_string = "focusyearme@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1190_triggered {
	meta: description = "Rule # 1190 Suspicious String for All My Friends and All Defacer triggered"
	strings: $suspicious_string = "for All My Friends and All Defacer"
	condition: $suspicious_string
}
rule Rule_1191_triggered {
	meta: description = "Rule # 1191 Suspicious String frankcasanas.com/tmp/zzz.txt triggered"
	strings: $suspicious_string = "frankcasanas.com/tmp/zzz.txt"
	condition: $suspicious_string
}
rule Rule_1192_triggered {
	meta: description = "Rule # 1192 Suspicious String free shell triggered"
	strings: $suspicious_string = "free shell"
	condition: $suspicious_string
}
rule Rule_1193_triggered {
	meta: description = "Rule # 1193 Suspicious String freshnewly@she.com triggered"
	strings: $suspicious_string = "freshnewly@she.com"
	condition: $suspicious_string
}
rule Rule_1194_triggered {
	meta: description = "Rule # 1194 Suspicious String fretiles@fretillers.com triggered"
	strings: $suspicious_string = "fretiles@fretillers.com"
	condition: $suspicious_string
}
rule Rule_1195_triggered {
	meta: description = "Rule # 1195 Suspicious String from: EGFM triggered"
	strings: $suspicious_string = "from: EGFM"
	condition: $suspicious_string
}
rule Rule_1196_triggered {
	meta: description = "Rule # 1196 Suspicious String fuckyou4321 triggered"
	strings: $suspicious_string = "fuckyou4321"
	condition: $suspicious_string
}
rule Rule_1197_triggered {
	meta: description = "Rule # 1197 Suspicious String fukq triggered"
	strings: $suspicious_string = "fukq"
	condition: $suspicious_string
}
rule Rule_1198_triggered {
	meta: description = "Rule # 1198 Suspicious String func7PLUOCHPZY017 triggered"
	strings: $suspicious_string = "func7PLUOCHPZY017"
	condition: $suspicious_string
}
rule Rule_1199_triggered {
	meta: description = "Rule # 1199 Suspicious String func8YVJMH5AR86A52 triggered"
	strings: $suspicious_string = "func8YVJMH5AR86A52"
	condition: $suspicious_string
}
rule Rule_1200_triggered {
	meta: description = "Rule # 1200 Suspicious String funcXOUUTM54E67A triggered"
	strings: $suspicious_string = "funcXOUUTM54E67A"
	condition: $suspicious_string
}
rule Rule_1201_triggered {
	meta: description = "Rule # 1201 Suspicious String function madafuck triggered"
	strings: $suspicious_string = "function madafuck"
	condition: $suspicious_string
}
rule Rule_1202_triggered {
	meta: description = "Rule # 1202 Suspicious String fwso shell triggered"
	strings: $suspicious_string = "fwso shell"
	condition: $suspicious_string
}
rule Rule_1203_triggered {
	meta: description = "Rule # 1203 Suspicious String gabkinihun@gmail.com triggered"
	strings: $suspicious_string = "gabkinihun@gmail.com"
	condition: $suspicious_string
}
rule Rule_1204_triggered {
	meta: description = "Rule # 1204 Suspicious String geraldineb1963@hotmail.com triggered"
	strings: $suspicious_string = "geraldineb1963@hotmail.com"
	condition: $suspicious_string
}
rule Rule_1205_triggered {
	meta: description = "Rule # 1205 Suspicious String ggmail.html triggered"
	strings: $suspicious_string = "ggmail.html"
	condition: $suspicious_string
}
rule Rule_1206_triggered {
	meta: description = "Rule # 1206 Suspicious String gh0st triggered"
	strings: $suspicious_string = "gh0st"
	condition: $suspicious_string
}
rule Rule_1207_triggered {
	meta: description = "Rule # 1207 Suspicious String gif89a<?php triggered"
	strings: $suspicious_string = "gif89a<?php"
	condition: $suspicious_string
}
rule Rule_1208_triggered {
	meta: description = "Rule # 1208 Suspicious String gmbpr triggered"
	strings: $suspicious_string = "gmbpr"
	condition: $suspicious_string
}
rule Rule_1209_triggered {
	meta: description = "Rule # 1209 Suspicious String goldmanagement2@gmail.com triggered"
	strings: $suspicious_string = "goldmanagement2@gmail.com"
	condition: $suspicious_string
}
rule Rule_1210_triggered {
	meta: description = "Rule # 1210 Suspicious String golr.us.to triggered"
	strings: $suspicious_string = "golr.us.to"
	condition: $suspicious_string
}
rule Rule_1211_triggered {
	meta: description = "Rule # 1211 Suspicious String goodnewsyeso@gmail.com triggered"
	strings: $suspicious_string = "goodnewsyeso@gmail.com"
	condition: $suspicious_string
}
rule Rule_1212_triggered {
	meta: description = "Rule # 1212 Suspicious String goodslife201 triggered"
	strings: $suspicious_string = "goodslife201"
	condition: $suspicious_string
}
rule Rule_1213_triggered {
	meta: description = "Rule # 1213 Suspicious String google.ssl.info.cc triggered"
	strings: $suspicious_string = "google.ssl.info.cc"
	condition: $suspicious_string
}
rule Rule_1214_triggered {
	meta: description = "Rule # 1214 Suspicious String google_warrior triggered"
	strings: $suspicious_string = "google_warrior"
	condition: $suspicious_string
}
rule Rule_1215_triggered {
	meta: description = "Rule # 1215 Suspicious String grav3 triggered"
	strings: $suspicious_string = "grav3"
	condition: $suspicious_string
}
rule Rule_1216_triggered {
	meta: description = "Rule # 1216 Suspicious String guardservices triggered"
	strings: $suspicious_string = "guardservices"
	condition: $suspicious_string
}
rule Rule_1217_triggered {
	meta: description = "Rule # 1217 Suspicious String gujj4rPcP triggered"
	strings: $suspicious_string = "gujj4rPcP"
	condition: $suspicious_string
}
rule Rule_1218_triggered {
	meta: description = "Rule # 1218 Suspicious String h4xc0rp triggered"
	strings: $suspicious_string = "h4xc0rp"
	condition: $suspicious_string
}
rule Rule_1219_triggered {
	meta: description = "Rule # 1219 Suspicious String hack-back triggered"
	strings: $suspicious_string = "hack-back"
	condition: $suspicious_string
}
rule Rule_1220_triggered {
	meta: description = "Rule # 1220 Suspicious String hackattackdude@gmail.com triggered"
	strings: $suspicious_string = "hackattackdude@gmail.com"
	condition: $suspicious_string
}
rule Rule_1221_triggered {
	meta: description = "Rule # 1221 Suspicious String hacked By Chinafans triggered"
	strings: $suspicious_string = "hacked By Chinafans"
	condition: $suspicious_string
}
rule Rule_1222_triggered {
	meta: description = "Rule # 1222 Suspicious String hacked By Fallag Gassrini triggered"
	strings: $suspicious_string = "hacked By Fallag Gassrini"
	condition: $suspicious_string
}
rule Rule_1223_triggered {
	meta: description = "Rule # 1223 Suspicious String hacked by  triggered"
	strings: $suspicious_string = "hacked by "
	condition: $suspicious_string
}
rule Rule_1224_triggered {
	meta: description = "Rule # 1224 Suspicious String hacked by ./zar0us triggered"
	strings: $suspicious_string = "hacked by ./zar0us"
	condition: $suspicious_string
}
rule Rule_1225_triggered {
	meta: description = "Rule # 1225 Suspicious String hacked by MRH.404 triggered"
	strings: $suspicious_string = "hacked by MRH.404"
	condition: $suspicious_string
}
rule Rule_1226_triggered {
	meta: description = "Rule # 1226 Suspicious String hacked by NG689Skw triggered"
	strings: $suspicious_string = "hacked by NG689Skw"
	condition: $suspicious_string
}
rule Rule_1227_triggered {
	meta: description = "Rule # 1227 Suspicious String hackmeplz triggered"
	strings: $suspicious_string = "hackmeplz"
	condition: $suspicious_string
}
rule Rule_1228_triggered {
	meta: description = "Rule # 1228 Suspicious String hamzabkr40@gmail.com triggered"
	strings: $suspicious_string = "hamzabkr40@gmail.com"
	condition: $suspicious_string
}
rule Rule_1229_triggered {
	meta: description = "Rule # 1229 Suspicious String haxor wibu triggered"
	strings: $suspicious_string = "haxor wibu"
	condition: $suspicious_string
}
rule Rule_1230_triggered {
	meta: description = "Rule # 1230 Suspicious String heihei triggered"
	strings: $suspicious_string = "heihei"
	condition: $suspicious_string
}
rule Rule_1231_triggered {
	meta: description = "Rule # 1231 Suspicious String helegedada triggered"
	strings: $suspicious_string = "helegedada"
	condition: $suspicious_string
}
rule Rule_1232_triggered {
	meta: description = "Rule # 1232 Suspicious String hfbakhsh.com triggered"
	strings: $suspicious_string = "hfbakhsh.com"
	condition: $suspicious_string
}
rule Rule_1233_triggered {
	meta: description = "Rule # 1233 Suspicious String hidden uploader triggered"
	strings: $suspicious_string = "hidden uploader"
	condition: $suspicious_string
}
rule Rule_1234_triggered {
	meta: description = "Rule # 1234 Suspicious String homeaway.com triggered"
	strings: $suspicious_string = "homeaway.com"
	condition: $suspicious_string
}
rule Rule_1235_triggered {
	meta: description = "Rule # 1235 Suspicious String horneymace@gmail.com triggered"
	strings: $suspicious_string = "horneymace@gmail.com"
	condition: $suspicious_string
}
rule Rule_1236_triggered {
	meta: description = "Rule # 1236 Suspicious String hrhbox2015@gmail.com triggered"
	strings: $suspicious_string = "hrhbox2015@gmail.com"
	condition: $suspicious_string
}
rule Rule_1237_triggered {
	meta: description = "Rule # 1237 Suspicious String http://3.bp.blogspot.com triggered"
	strings: $suspicious_string = "http://3.bp.blogspot.com"
	condition: $suspicious_string
}
rule Rule_1238_triggered {
	meta: description = "Rule # 1238 Suspicious String http://PaLteam.Org triggered"
	strings: $suspicious_string = "http://PaLteam.Org"
	condition: $suspicious_string
}
rule Rule_1239_triggered {
	meta: description = "Rule # 1239 Suspicious String http://a1b2cd.club/ triggered"
	strings: $suspicious_string = "http://a1b2cd.club/"
	condition: $suspicious_string
}
rule Rule_1240_triggered {
	meta: description = "Rule # 1240 Suspicious String http://fb.com/AyyildizTim1919 triggered"
	strings: $suspicious_string = "http://fb.com/AyyildizTim1919"
	condition: $suspicious_string
}
rule Rule_1241_triggered {
	meta: description = "Rule # 1241 Suspicious String http://fb.com/CazanovaHaxorStore triggered"
	strings: $suspicious_string = "http://fb.com/CazanovaHaxorStore"
	condition: $suspicious_string
}
rule Rule_1242_triggered {
	meta: description = "Rule # 1242 Suspicious String http://ghc.ru triggered"
	strings: $suspicious_string = "http://ghc.ru"
	condition: $suspicious_string
}
rule Rule_1243_triggered {
	meta: description = "Rule # 1243 Suspicious String http://rst.void.ru triggered"
	strings: $suspicious_string = "http://rst.void.ru"
	condition: $suspicious_string
}
rule Rule_1244_triggered {
	meta: description = "Rule # 1244 Suspicious String http://www.sa-hacker.com/vb triggered"
	strings: $suspicious_string = "http://www.sa-hacker.com/vb"
	condition: $suspicious_string
}
rule Rule_1245_triggered {
	meta: description = "Rule # 1245 Suspicious String http://yourservices.live/include.js triggered"
	strings: $suspicious_string = "http://yourservices.live/include.js"
	condition: $suspicious_string
}
rule Rule_1246_triggered {
	meta: description = "Rule # 1246 Suspicious String https://fb.com/Jokr.H4xor triggered"
	strings: $suspicious_string = "https://fb.com/Jokr.H4xor"
	condition: $suspicious_string
}
rule Rule_1247_triggered {
	meta: description = "Rule # 1247 Suspicious String https://fb.com/fir3.hawk5 triggered"
	strings: $suspicious_string = "https://fb.com/fir3.hawk5"
	condition: $suspicious_string
}
rule Rule_1248_triggered {
	meta: description = "Rule # 1248 Suspicious String https://firefart.at triggered"
	strings: $suspicious_string = "https://firefart.at"
	condition: $suspicious_string
}
rule Rule_1249_triggered {
	meta: description = "Rule # 1249 Suspicious String https://github.com/dirtycow/dirtycow.github.io/blob/master/pokemon.c triggered"
	strings: $suspicious_string = "https://github.com/dirtycow/dirtycow.github.io/blob/master/pokemon.c"
	condition: $suspicious_string
}
rule Rule_1250_triggered {
	meta: description = "Rule # 1250 Suspicious String https://twitter.com/nilotpalhacker triggered"
	strings: $suspicious_string = "https://twitter.com/nilotpalhacker"
	condition: $suspicious_string
}
rule Rule_1251_triggered {
	meta: description = "Rule # 1251 Suspicious String https://www.facebook.com/nilotpal.biswas.73 triggered"
	strings: $suspicious_string = "https://www.facebook.com/nilotpal.biswas.73"
	condition: $suspicious_string
}
rule Rule_1252_triggered {
	meta: description = "Rule # 1252 Suspicious String https://www.facebook.com/xaisyndicate triggered"
	strings: $suspicious_string = "https://www.facebook.com/xaisyndicate"
	condition: $suspicious_string
}
rule Rule_1253_triggered {
	meta: description = "Rule # 1253 Suspicious String huken90@gmail.com triggered"
	strings: $suspicious_string = "huken90@gmail.com"
	condition: $suspicious_string
}
rule Rule_1254_triggered {
	meta: description = "Rule # 1254 Suspicious String hussin_v@ymail.com triggered"
	strings: $suspicious_string = "hussin_v@ymail.com"
	condition: $suspicious_string
}
rule Rule_1255_triggered {
	meta: description = "Rule # 1255 Suspicious String i129648e triggered"
	strings: $suspicious_string = "i129648e"
	condition: $suspicious_string
}
rule Rule_1256_triggered {
	meta: description = "Rule # 1256 Suspicious String iLL Skillz triggered"
	strings: $suspicious_string = "iLL Skillz"
	condition: $suspicious_string
}
rule Rule_1257_triggered {
	meta: description = "Rule # 1257 Suspicious String iMHATiMi.ORG triggered"
	strings: $suspicious_string = "iMHATiMi.ORG"
	condition: $suspicious_string
}
rule Rule_1258_triggered {
	meta: description = "Rule # 1258 Suspicious String iamtriumphant07@gmail.com triggered"
	strings: $suspicious_string = "iamtriumphant07@gmail.com"
	condition: $suspicious_string
}
rule Rule_1259_triggered {
	meta: description = "Rule # 1259 Suspicious String if do you want rezultaa text in html file triggered"
	strings: $suspicious_string = "if do you want rezultaa text in html file"
	condition: $suspicious_string
}
rule Rule_1260_triggered {
	meta: description = "Rule # 1260 Suspicious String if you want to victem showed bank page triggered"
	strings: $suspicious_string = "if you want to victem showed bank page"
	condition: $suspicious_string
}
rule Rule_1261_triggered {
	meta: description = "Rule # 1261 Suspicious String imprisond triggered"
	strings: $suspicious_string = "imprisond"
	condition: $suspicious_string
}
rule Rule_1262_triggered {
	meta: description = "Rule # 1262 Suspicious String indoxploit.or.id triggered"
	strings: $suspicious_string = "indoxploit.or.id"
	condition: $suspicious_string
}
rule Rule_1263_triggered {
	meta: description = "Rule # 1263 Suspicious String info@el-nacional.com triggered"
	strings: $suspicious_string = "info@el-nacional.com"
	condition: $suspicious_string
}
rule Rule_1264_triggered {
	meta: description = "Rule # 1264 Suspicious String info@xsender.com triggered"
	strings: $suspicious_string = "info@xsender.com"
	condition: $suspicious_string
}
rule Rule_1265_triggered {
	meta: description = "Rule # 1265 Suspicious String infoicb76@gmail.com triggered"
	strings: $suspicious_string = "infoicb76@gmail.com"
	condition: $suspicious_string
}
rule Rule_1266_triggered {
	meta: description = "Rule # 1266 Suspicious String infos@Aguda.ng triggered"
	strings: $suspicious_string = "infos@Aguda.ng"
	condition: $suspicious_string
}
rule Rule_1267_triggered {
	meta: description = "Rule # 1267 Suspicious String injectoDaher triggered"
	strings: $suspicious_string = "injectoDaher"
	condition: $suspicious_string
}
rule Rule_1268_triggered {
	meta: description = "Rule # 1268 Suspicious String inspiredlean@gmai.com triggered"
	strings: $suspicious_string = "inspiredlean@gmai.com"
	condition: $suspicious_string
}
rule Rule_1269_triggered {
	meta: description = "Rule # 1269 Suspicious String intuit.com triggered"
	strings: $suspicious_string = "intuit.com"
	condition: $suspicious_string
}
rule Rule_1270_triggered {
	meta: description = "Rule # 1270 Suspicious String isek500@aol.com triggered"
	strings: $suspicious_string = "isek500@aol.com"
	condition: $suspicious_string
}
rule Rule_1271_triggered {
	meta: description = "Rule # 1271 Suspicious String iskorpitx triggered"
	strings: $suspicious_string = "iskorpitx"
	condition: $suspicious_string
}
rule Rule_1272_triggered {
	meta: description = "Rule # 1272 Suspicious String itu dosa gan triggered"
	strings: $suspicious_string = "itu dosa gan"
	condition: $suspicious_string
}
rule Rule_1273_triggered {
	meta: description = "Rule # 1273 Suspicious String jacGX triggered"
	strings: $suspicious_string = "jacGX"
	condition: $suspicious_string
}
rule Rule_1274_triggered {
	meta: description = "Rule # 1274 Suspicious String jacksmith3811@gmail.com triggered"
	strings: $suspicious_string = "jacksmith3811@gmail.com"
	condition: $suspicious_string
}
rule Rule_1275_triggered {
	meta: description = "Rule # 1275 Suspicious String jamesmathinsclaims@gmail.com triggered"
	strings: $suspicious_string = "jamesmathinsclaims@gmail.com"
	condition: $suspicious_string
}
rule Rule_1276_triggered {
	meta: description = "Rule # 1276 Suspicious String jancok torok empek asooooooh triggered"
	strings: $suspicious_string = "jancok torok empek asooooooh"
	condition: $suspicious_string
}
rule Rule_1277_triggered {
	meta: description = "Rule # 1277 Suspicious String jbossass.war triggered"
	strings: $suspicious_string = "jbossass.war"
	condition: $suspicious_string
}
rule Rule_1278_triggered {
	meta: description = "Rule # 1278 Suspicious String je253824 triggered"
	strings: $suspicious_string = "je253824"
	condition: $suspicious_string
}
rule Rule_1279_triggered {
	meta: description = "Rule # 1279 Suspicious String jeff4r-partner@tutanota.com triggered"
	strings: $suspicious_string = "jeff4r-partner@tutanota.com"
	condition: $suspicious_string
}
rule Rule_1280_triggered {
	meta: description = "Rule # 1280 Suspicious String jem.smith@yandex.com triggered"
	strings: $suspicious_string = "jem.smith@yandex.com"
	condition: $suspicious_string
}
rule Rule_1281_triggered {
	meta: description = "Rule # 1281 Suspicious String jepry_vuln  triggered"
	strings: $suspicious_string = "jepry_vuln "
	condition: $suspicious_string
}
rule Rule_1282_triggered {
	meta: description = "Rule # 1282 Suspicious String jessica_biel_naked_in_my_bed.c triggered"
	strings: $suspicious_string = "jessica_biel_naked_in_my_bed.c"
	condition: $suspicious_string
}
rule Rule_1283_triggered {
	meta: description = "Rule # 1283 Suspicious String jexboss triggered"
	strings: $suspicious_string = "jexboss"
	condition: $suspicious_string
}
rule Rule_1284_triggered {
	meta: description = "Rule # 1284 Suspicious String jo mass info changer triggered"
	strings: $suspicious_string = "jo mass info changer"
	condition: $suspicious_string
}
rule Rule_1285_triggered {
	meta: description = "Rule # 1285 Suspicious String joaomatosf.com triggered"
	strings: $suspicious_string = "joaomatosf.com"
	condition: $suspicious_string
}
rule Rule_1286_triggered {
	meta: description = "Rule # 1286 Suspicious String johnsonjames002dc@outlook.com triggered"
	strings: $suspicious_string = "johnsonjames002dc@outlook.com"
	condition: $suspicious_string
}
rule Rule_1287_triggered {
	meta: description = "Rule # 1287 Suspicious String jugaad XD triggered"
	strings: $suspicious_string = "jugaad XD"
	condition: $suspicious_string
}
rule Rule_1288_triggered {
	meta: description = "Rule # 1288 Suspicious String junglesec@anonymousspeech.com triggered"
	strings: $suspicious_string = "junglesec@anonymousspeech.com"
	condition: $suspicious_string
}
rule Rule_1289_triggered {
	meta: description = "Rule # 1289 Suspicious String jwcucfcqiqs triggered"
	strings: $suspicious_string = "jwcucfcqiqs"
	condition: $suspicious_string
}
rule Rule_1290_triggered {
	meta: description = "Rule # 1290 Suspicious String jweyc triggered"
	strings: $suspicious_string = "jweyc"
	condition: $suspicious_string
}
rule Rule_1291_triggered {
	meta: description = "Rule # 1291 Suspicious String k2ll33d triggered"
	strings: $suspicious_string = "k2ll33d"
	condition: $suspicious_string
}
rule Rule_1292_triggered {
	meta: description = "Rule # 1292 Suspicious String k2ll33d shell triggered"
	strings: $suspicious_string = "k2ll33d shell"
	condition: $suspicious_string
}
rule Rule_1293_triggered {
	meta: description = "Rule # 1293 Suspicious String k3y r3ZulT triggered"
	strings: $suspicious_string = "k3y r3ZulT"
	condition: $suspicious_string
}
rule Rule_1294_triggered {
	meta: description = "Rule # 1294 Suspicious String k4l0nk triggered"
	strings: $suspicious_string = "k4l0nk"
	condition: $suspicious_string
}
rule Rule_1295_triggered {
	meta: description = "Rule # 1295 Suspicious String kaMtiEz triggered"
	strings: $suspicious_string = "kaMtiEz"
	condition: $suspicious_string
}
rule Rule_1296_triggered {
	meta: description = "Rule # 1296 Suspicious String kefiex404    triggered"
	strings: $suspicious_string = "kefiex404   "
	condition: $suspicious_string
}
rule Rule_1297_triggered {
	meta: description = "Rule # 1297 Suspicious String kerde khaat khadi triggered"
	strings: $suspicious_string = "kerde khaat khadi"
	condition: $suspicious_string
}
rule Rule_1298_triggered {
	meta: description = "Rule # 1298 Suspicious String ki739937@gmail.com triggered"
	strings: $suspicious_string = "ki739937@gmail.com"
	condition: $suspicious_string
}
rule Rule_1299_triggered {
	meta: description = "Rule # 1299 Suspicious String kid Security Team triggered"
	strings: $suspicious_string = "kid Security Team"
	condition: $suspicious_string
}
rule Rule_1300_triggered {
	meta: description = "Rule # 1300 Suspicious String kid Si Vip Security Team triggered"
	strings: $suspicious_string = "kid Si Vip Security Team"
	condition: $suspicious_string
}
rule Rule_1301_triggered {
	meta: description = "Rule # 1301 Suspicious String kinbokun2234@gmail.com triggered"
	strings: $suspicious_string = "kinbokun2234@gmail.com"
	condition: $suspicious_string
}
rule Rule_1302_triggered {
	meta: description = "Rule # 1302 Suspicious String kntnight@gmail.com triggered"
	strings: $suspicious_string = "kntnight@gmail.com"
	condition: $suspicious_string
}
rule Rule_1303_triggered {
	meta: description = "Rule # 1303 Suspicious String kohehasa@gmail.com triggered"
	strings: $suspicious_string = "kohehasa@gmail.com"
	condition: $suspicious_string
}
rule Rule_1304_triggered {
	meta: description = "Rule # 1304 Suspicious String koneksi eror     triggered"
	strings: $suspicious_string = "koneksi eror    "
	condition: $suspicious_string
}
rule Rule_1305_triggered {
	meta: description = "Rule # 1305 Suspicious String krad.c triggered"
	strings: $suspicious_string = "krad.c"
	condition: $suspicious_string
}
rule Rule_1306_triggered {
	meta: description = "Rule # 1306 Suspicious String kunlexy triggered"
	strings: $suspicious_string = "kunlexy"
	condition: $suspicious_string
}
rule Rule_1307_triggered {
	meta: description = "Rule # 1307 Suspicious String l14deaad triggered"
	strings: $suspicious_string = "l14deaad"
	condition: $suspicious_string
}
rule Rule_1308_triggered {
	meta: description = "Rule # 1308 Suspicious String l2ncbf06ku_1psr8yxia triggered"
	strings: $suspicious_string = "l2ncbf06ku_1psr8yxia"
	condition: $suspicious_string
}
rule Rule_1309_triggered {
	meta: description = "Rule # 1309 Suspicious String lalabitch.php triggered"
	strings: $suspicious_string = "lalabitch.php"
	condition: $suspicious_string
}
rule Rule_1310_triggered {
	meta: description = "Rule # 1310 Suspicious String lassp2030@gmail.com triggered"
	strings: $suspicious_string = "lassp2030@gmail.com"
	condition: $suspicious_string
}
rule Rule_1311_triggered {
	meta: description = "Rule # 1311 Suspicious String laterain testin9 triggered"
	strings: $suspicious_string = "laterain testin9"
	condition: $suspicious_string
}
rule Rule_1312_triggered {
	meta: description = "Rule # 1312 Suspicious String leahmc1@rocketmail.com triggered"
	strings: $suspicious_string = "leahmc1@rocketmail.com"
	condition: $suspicious_string
}
rule Rule_1313_triggered {
	meta: description = "Rule # 1313 Suspicious String legend.rocks triggered"
	strings: $suspicious_string = "legend.rocks"
	condition: $suspicious_string
}
rule Rule_1314_triggered {
	meta: description = "Rule # 1314 Suspicious String linus.danny@outlook.com triggered"
	strings: $suspicious_string = "linus.danny@outlook.com"
	condition: $suspicious_string
}
rule Rule_1315_triggered {
	meta: description = "Rule # 1315 Suspicious String linusdanny7@gmail.com triggered"
	strings: $suspicious_string = "linusdanny7@gmail.com"
	condition: $suspicious_string
}
rule Rule_1316_triggered {
	meta: description = "Rule # 1316 Suspicious String linux-op.com triggered"
	strings: $suspicious_string = "linux-op.com"
	condition: $suspicious_string
}
rule Rule_1317_triggered {
	meta: description = "Rule # 1317 Suspicious String lithest triggered"
	strings: $suspicious_string = "lithest"
	condition: $suspicious_string
}
rule Rule_1318_triggered {
	meta: description = "Rule # 1318 Suspicious String localhost_80@hotmail.com triggered"
	strings: $suspicious_string = "localhost_80@hotmail.com"
	condition: $suspicious_string
}
rule Rule_1319_triggered {
	meta: description = "Rule # 1319 Suspicious String login.yahoo.com triggered"
	strings: $suspicious_string = "login.yahoo.com"
	condition: $suspicious_string
}
rule Rule_1320_triggered {
	meta: description = "Rule # 1320 Suspicious String lovetherisk<br>Suriya Prakash triggered"
	strings: $suspicious_string = "lovetherisk<br>Suriya Prakash"
	condition: $suspicious_string
}
rule Rule_1321_triggered {
	meta: description = "Rule # 1321 Suspicious String lt@mac.hush.com triggered"
	strings: $suspicious_string = "lt@mac.hush.com"
	condition: $suspicious_string
}
rule Rule_1322_triggered {
	meta: description = "Rule # 1322 Suspicious String luis.arnold12@yahoo.com triggered"
	strings: $suspicious_string = "luis.arnold12@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1323_triggered {
	meta: description = "Rule # 1323 Suspicious String luxury handbags triggered"
	strings: $suspicious_string = "luxury handbags"
	condition: $suspicious_string
}
rule Rule_1324_triggered {
	meta: description = "Rule # 1324 Suspicious String lymanlymco triggered"
	strings: $suspicious_string = "lymanlymco"
	condition: $suspicious_string
}
rule Rule_1325_triggered {
	meta: description = "Rule # 1325 Suspicious String m0rtix triggered"
	strings: $suspicious_string = "m0rtix"
	condition: $suspicious_string
}
rule Rule_1326_triggered {
	meta: description = "Rule # 1326 Suspicious String m2118d22d991cc8bfb66304d5bd2ee973 triggered"
	strings: $suspicious_string = "m2118d22d991cc8bfb66304d5bd2ee973"
	condition: $suspicious_string
}
rule Rule_1327_triggered {
	meta: description = "Rule # 1327 Suspicious String m@db100d  triggered"
	strings: $suspicious_string = "m@db100d "
	condition: $suspicious_string
}
rule Rule_1328_triggered {
	meta: description = "Rule # 1328 Suspicious String madubueze.simon@yahoo.com triggered"
	strings: $suspicious_string = "madubueze.simon@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1329_triggered {
	meta: description = "Rule # 1329 Suspicious String mageonline.net/js/mage.js triggered"
	strings: $suspicious_string = "mageonline.net/js/mage.js"
	condition: $suspicious_string
}
rule Rule_1330_triggered {
	meta: description = "Rule # 1330 Suspicious String mahdi WAS HERE triggered"
	strings: $suspicious_string = "mahdi WAS HERE"
	condition: $suspicious_string
}
rule Rule_1331_triggered {
	meta: description = "Rule # 1331 Suspicious String mahmud.ghazni.1 triggered"
	strings: $suspicious_string = "mahmud.ghazni.1"
	condition: $suspicious_string
}
rule Rule_1332_triggered {
	meta: description = "Rule # 1332 Suspicious String mahmud.ghazni@yahoo.com triggered"
	strings: $suspicious_string = "mahmud.ghazni@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1333_triggered {
	meta: description = "Rule # 1333 Suspicious String makman.php triggered"
	strings: $suspicious_string = "makman.php"
	condition: $suspicious_string
}
rule Rule_1334_triggered {
	meta: description = "Rule # 1334 Suspicious String managedforexaccount triggered"
	strings: $suspicious_string = "managedforexaccount"
	condition: $suspicious_string
}
rule Rule_1335_triggered {
	meta: description = "Rule # 1335 Suspicious String marli.vianna00@gmail.com triggered"
	strings: $suspicious_string = "marli.vianna00@gmail.com"
	condition: $suspicious_string
}
rule Rule_1336_triggered {
	meta: description = "Rule # 1336 Suspicious String mass defacer and log eraser triggered"
	strings: $suspicious_string = "mass defacer and log eraser"
	condition: $suspicious_string
}
rule Rule_1337_triggered {
	meta: description = "Rule # 1337 Suspicious String matamu picek triggered"
	strings: $suspicious_string = "matamu picek"
	condition: $suspicious_string
}
rule Rule_1338_triggered {
	meta: description = "Rule # 1338 Suspicious String mauritania attacker triggered"
	strings: $suspicious_string = "mauritania attacker"
	condition: $suspicious_string
}
rule Rule_1339_triggered {
	meta: description = "Rule # 1339 Suspicious String md5decrpter triggered"
	strings: $suspicious_string = "md5decrpter"
	condition: $suspicious_string
}
rule Rule_1340_triggered {
	meta: description = "Rule # 1340 Suspicious String me@faialahmed.me triggered"
	strings: $suspicious_string = "me@faialahmed.me"
	condition: $suspicious_string
}
rule Rule_1341_triggered {
	meta: description = "Rule # 1341 Suspicious String mer4en7y triggered"
	strings: $suspicious_string = "mer4en7y"
	condition: $suspicious_string
}
rule Rule_1342_triggered {
	meta: description = "Rule # 1342 Suspicious String mercychase1@gmail.com triggered"
	strings: $suspicious_string = "mercychase1@gmail.com"
	condition: $suspicious_string
}
rule Rule_1343_triggered {
	meta: description = "Rule # 1343 Suspicious String mesaegs triggered"
	strings: $suspicious_string = "mesaegs"
	condition: $suspicious_string
}
rule Rule_1344_triggered {
	meta: description = "Rule # 1344 Suspicious String mhmadmasrwe triggered"
	strings: $suspicious_string = "mhmadmasrwe"
	condition: $suspicious_string
}
rule Rule_1345_triggered {
	meta: description = "Rule # 1345 Suspicious String micheal5ur3@gmail.com triggered"
	strings: $suspicious_string = "micheal5ur3@gmail.com"
	condition: $suspicious_string
}
rule Rule_1346_triggered {
	meta: description = "Rule # 1346 Suspicious String micr0s0flt.acc0unt@hotmail.com triggered"
	strings: $suspicious_string = "micr0s0flt.acc0unt@hotmail.com"
	condition: $suspicious_string
}
rule Rule_1347_triggered {
	meta: description = "Rule # 1347 Suspicious String mike waals triggered"
	strings: $suspicious_string = "mike waals"
	condition: $suspicious_string
}
rule Rule_1348_triggered {
	meta: description = "Rule # 1348 Suspicious String milw0rm triggered"
	strings: $suspicious_string = "milw0rm"
	condition: $suspicious_string
}
rule Rule_1349_triggered {
	meta: description = "Rule # 1349 Suspicious String minexmr triggered"
	strings: $suspicious_string = "minexmr"
	condition: $suspicious_string
}
rule Rule_1350_triggered {
	meta: description = "Rule # 1350 Suspicious String monoki.atspace.com triggered"
	strings: $suspicious_string = "monoki.atspace.com"
	condition: $suspicious_string
}
rule Rule_1351_triggered {
	meta: description = "Rule # 1351 Suspicious String mooremoney1900@gmail.com triggered"
	strings: $suspicious_string = "mooremoney1900@gmail.com"
	condition: $suspicious_string
}
rule Rule_1352_triggered {
	meta: description = "Rule # 1352 Suspicious String morganstanley.com triggered"
	strings: $suspicious_string = "morganstanley.com"
	condition: $suspicious_string
}
rule Rule_1353_triggered {
	meta: description = "Rule # 1353 Suspicious String mr.cookie_302 triggered"
	strings: $suspicious_string = "mr.cookie_302"
	condition: $suspicious_string
}
rule Rule_1354_triggered {
	meta: description = "Rule # 1354 Suspicious String mtwer.com triggered"
	strings: $suspicious_string = "mtwer.com"
	condition: $suspicious_string
}
rule Rule_1355_triggered {
	meta: description = "Rule # 1355 Suspicious String mugiwaranoluffy@fastmail.com triggered"
	strings: $suspicious_string = "mugiwaranoluffy@fastmail.com"
	condition: $suspicious_string
}
rule Rule_1356_triggered {
	meta: description = "Rule # 1356 Suspicious String mvp.collinsrobinson@mail.ru triggered"
	strings: $suspicious_string = "mvp.collinsrobinson@mail.ru"
	condition: $suspicious_string
}
rule Rule_1357_triggered {
	meta: description = "Rule # 1357 Suspicious String myrealday1@gmail.com triggered"
	strings: $suspicious_string = "myrealday1@gmail.com"
	condition: $suspicious_string
}
rule Rule_1358_triggered {
	meta: description = "Rule # 1358 Suspicious String n5c098ab8546b2 triggered"
	strings: $suspicious_string = "n5c098ab8546b2"
	condition: $suspicious_string
}
rule Rule_1359_triggered {
	meta: description = "Rule # 1359 Suspicious String n96I4A33EYNVO71FC.Program triggered"
	strings: $suspicious_string = "n96I4A33EYNVO71FC.Program"
	condition: $suspicious_string
}
rule Rule_1360_triggered {
	meta: description = "Rule # 1360 Suspicious String n9nj2.X triggered"
	strings: $suspicious_string = "n9nj2.X"
	condition: $suspicious_string
}
rule Rule_1361_triggered {
	meta: description = "Rule # 1361 Suspicious String neighborer triggered"
	strings: $suspicious_string = "neighborer"
	condition: $suspicious_string
}
rule Rule_1362_triggered {
	meta: description = "Rule # 1362 Suspicious String netjackal.by.ru triggered"
	strings: $suspicious_string = "netjackal.by.ru"
	condition: $suspicious_string
}
rule Rule_1363_triggered {
	meta: description = "Rule # 1363 Suspicious String newCredentials triggered"
	strings: $suspicious_string = "newCredentials"
	condition: $suspicious_string
}
rule Rule_1364_triggered {
	meta: description = "Rule # 1364 Suspicious String newbie patah hati  triggered"
	strings: $suspicious_string = "newbie patah hati "
	condition: $suspicious_string
}
rule Rule_1365_triggered {
	meta: description = "Rule # 1365 Suspicious String neweggstats.com triggered"
	strings: $suspicious_string = "neweggstats.com"
	condition: $suspicious_string
}
rule Rule_1366_triggered {
	meta: description = "Rule # 1366 Suspicious String newlife1470@gmail.com triggered"
	strings: $suspicious_string = "newlife1470@gmail.com"
	condition: $suspicious_string
}
rule Rule_1367_triggered {
	meta: description = "Rule # 1367 Suspicious String newmeak@gmail.com triggered"
	strings: $suspicious_string = "newmeak@gmail.com"
	condition: $suspicious_string
}
rule Rule_1368_triggered {
	meta: description = "Rule # 1368 Suspicious String newsupdate@servicedrive.com triggered"
	strings: $suspicious_string = "newsupdate@servicedrive.com"
	condition: $suspicious_string
}
rule Rule_1369_triggered {
	meta: description = "Rule # 1369 Suspicious String newsupdate@servisdropbox.com triggered"
	strings: $suspicious_string = "newsupdate@servisdropbox.com"
	condition: $suspicious_string
}
rule Rule_1370_triggered {
	meta: description = "Rule # 1370 Suspicious String newsupdated@servisd.com triggered"
	strings: $suspicious_string = "newsupdated@servisd.com"
	condition: $suspicious_string
}
rule Rule_1371_triggered {
	meta: description = "Rule # 1371 Suspicious String nginx1337 triggered"
	strings: $suspicious_string = "nginx1337"
	condition: $suspicious_string
}
rule Rule_1372_triggered {
	meta: description = "Rule # 1372 Suspicious String nighttgr33n triggered"
	strings: $suspicious_string = "nighttgr33n"
	condition: $suspicious_string
}
rule Rule_1373_triggered {
	meta: description = "Rule # 1373 Suspicious String ninja_1263 triggered"
	strings: $suspicious_string = "ninja_1263"
	condition: $suspicious_string
}
rule Rule_1374_triggered {
	meta: description = "Rule # 1374 Suspicious String notification.job@gmail.com triggered"
	strings: $suspicious_string = "notification.job@gmail.com"
	condition: $suspicious_string
}
rule Rule_1375_triggered {
	meta: description = "Rule # 1375 Suspicious String o8aedac7 triggered"
	strings: $suspicious_string = "o8aedac7"
	condition: $suspicious_string
}
rule Rule_1376_triggered {
	meta: description = "Rule # 1376 Suspicious String oalah asoooooooooooh triggered"
	strings: $suspicious_string = "oalah asoooooooooooh"
	condition: $suspicious_string
}
rule Rule_1377_triggered {
	meta: description = "Rule # 1377 Suspicious String oficeofthe@gmail.com triggered"
	strings: $suspicious_string = "oficeofthe@gmail.com"
	condition: $suspicious_string
}
rule Rule_1378_triggered {
	meta: description = "Rule # 1378 Suspicious String online encode by cha88.cn triggered"
	strings: $suspicious_string = "online encode by cha88.cn"
	condition: $suspicious_string
}
rule Rule_1379_triggered {
	meta: description = "Rule # 1379 Suspicious String owhggiku triggered"
	strings: $suspicious_string = "owhggiku"
	condition: $suspicious_string
}
rule Rule_1380_triggered {
	meta: description = "Rule # 1380 Suspicious String ownersdirectorsintl@gmail.com triggered"
	strings: $suspicious_string = "ownersdirectorsintl@gmail.com"
	condition: $suspicious_string
}
rule Rule_1381_triggered {
	meta: description = "Rule # 1381 Suspicious String ozcanlesbigboss@hotmail.fr triggered"
	strings: $suspicious_string = "ozcanlesbigboss@hotmail.fr"
	condition: $suspicious_string
}
rule Rule_1382_triggered {
	meta: description = "Rule # 1382 Suspicious String ozlok  triggered"
	strings: $suspicious_string = "ozlok "
	condition: $suspicious_string
}
rule Rule_1383_triggered {
	meta: description = "Rule # 1383 Suspicious String p0wny@shell triggered"
	strings: $suspicious_string = "p0wny@shell"
	condition: $suspicious_string
}
rule Rule_1384_triggered {
	meta: description = "Rule # 1384 Suspicious String p1mmaxweel@gmail.com triggered"
	strings: $suspicious_string = "p1mmaxweel@gmail.com"
	condition: $suspicious_string
}
rule Rule_1385_triggered {
	meta: description = "Rule # 1385 Suspicious String p4rs.net triggered"
	strings: $suspicious_string = "p4rs.net"
	condition: $suspicious_string
}
rule Rule_1386_triggered {
	meta: description = "Rule # 1386 Suspicious String p62a2e triggered"
	strings: $suspicious_string = "p62a2e"
	condition: $suspicious_string
}
rule Rule_1387_triggered {
	meta: description = "Rule # 1387 Suspicious String pOcOpOcO triggered"
	strings: $suspicious_string = "pOcOpOcO"
	condition: $suspicious_string
}
rule Rule_1388_triggered {
	meta: description = "Rule # 1388 Suspicious String passwbypass triggered"
	strings: $suspicious_string = "passwbypass"
	condition: $suspicious_string
}
rule Rule_1389_triggered {
	meta: description = "Rule # 1389 Suspicious String paulodadaj1@gmail.com triggered"
	strings: $suspicious_string = "paulodadaj1@gmail.com"
	condition: $suspicious_string
}
rule Rule_1390_triggered {
	meta: description = "Rule # 1390 Suspicious String php SSH triggered"
	strings: $suspicious_string = "php SSH"
	condition: $suspicious_string
}
rule Rule_1391_triggered {
	meta: description = "Rule # 1391 Suspicious String php_ini@126.com triggered"
	strings: $suspicious_string = "php_ini@126.com"
	condition: $suspicious_string
}
rule Rule_1392_triggered {
	meta: description = "Rule # 1392 Suspicious String phpremoteview triggered"
	strings: $suspicious_string = "phpremoteview"
	condition: $suspicious_string
}
rule Rule_1393_triggered {
	meta: description = "Rule # 1393 Suspicious String phpshell triggered"
	strings: $suspicious_string = "phpshell"
	condition: $suspicious_string
}
rule Rule_1394_triggered {
	meta: description = "Rule # 1394 Suspicious String phpsploitclass.php triggered"
	strings: $suspicious_string = "phpsploitclass.php"
	condition: $suspicious_string
}
rule Rule_1395_triggered {
	meta: description = "Rule # 1395 Suspicious String phpspypass triggered"
	strings: $suspicious_string = "phpspypass"
	condition: $suspicious_string
}
rule Rule_1396_triggered {
	meta: description = "Rule # 1396 Suspicious String pokemon exploit triggered"
	strings: $suspicious_string = "pokemon exploit"
	condition: $suspicious_string
}
rule Rule_1397_triggered {
	meta: description = "Rule # 1397 Suspicious String portal-f triggered"
	strings: $suspicious_string = "portal-f"
	condition: $suspicious_string
}
rule Rule_1398_triggered {
	meta: description = "Rule # 1398 Suspicious String poti.sadz@gmail.com triggered"
	strings: $suspicious_string = "poti.sadz@gmail.com"
	condition: $suspicious_string
}
rule Rule_1399_triggered {
	meta: description = "Rule # 1399 Suspicious String powered by os comerce triggered"
	strings: $suspicious_string = "powered by os comerce"
	condition: $suspicious_string
}
rule Rule_1400_triggered {
	meta: description = "Rule # 1400 Suspicious String prappo-prince.me triggered"
	strings: $suspicious_string = "prappo-prince.me"
	condition: $suspicious_string
}
rule Rule_1401_triggered {
	meta: description = "Rule # 1401 Suspicious String prepare_the_exploit triggered"
	strings: $suspicious_string = "prepare_the_exploit"
	condition: $suspicious_string
}
rule Rule_1402_triggered {
	meta: description = "Rule # 1402 Suspicious String psherwoodmarketing@gmail.com triggered"
	strings: $suspicious_string = "psherwoodmarketing@gmail.com"
	condition: $suspicious_string
}
rule Rule_1403_triggered {
	meta: description = "Rule # 1403 Suspicious String psybnc triggered"
	strings: $suspicious_string = "psybnc"
	condition: $suspicious_string
}
rule Rule_1404_triggered {
	meta: description = "Rule # 1404 Suspicious String ptrace_pokedata triggered"
	strings: $suspicious_string = "ptrace_pokedata"
	condition: $suspicious_string
}
rule Rule_1405_triggered {
	meta: description = "Rule # 1405 Suspicious String pw/XcTyTp triggered"
	strings: $suspicious_string = "pw/XcTyTp"
	condition: $suspicious_string
}
rule Rule_1406_triggered {
	meta: description = "Rule # 1406 Suspicious String pw/bash/include/xtaccess triggered"
	strings: $suspicious_string = "pw/bash/include/xtaccess"
	condition: $suspicious_string
}
rule Rule_1407_triggered {
	meta: description = "Rule # 1407 Suspicious String pwned triggered"
	strings: $suspicious_string = "pwned"
	condition: $suspicious_string
}
rule Rule_1408_triggered {
	meta: description = "Rule # 1408 Suspicious String python connect-back door triggered"
	strings: $suspicious_string = "python connect-back door"
	condition: $suspicious_string
}
rule Rule_1409_triggered {
	meta: description = "Rule # 1409 Suspicious String qusckboendqg triggered"
	strings: $suspicious_string = "qusckboendqg"
	condition: $suspicious_string
}
rule Rule_1410_triggered {
	meta: description = "Rule # 1410 Suspicious String r00txxPcP triggered"
	strings: $suspicious_string = "r00txxPcP"
	condition: $suspicious_string
}
rule Rule_1411_triggered {
	meta: description = "Rule # 1411 Suspicious String r0nin triggered"
	strings: $suspicious_string = "r0nin"
	condition: $suspicious_string
}
rule Rule_1412_triggered {
	meta: description = "Rule # 1412 Suspicious String r3coded by Kerupuk triggered"
	strings: $suspicious_string = "r3coded by Kerupuk"
	condition: $suspicious_string
}
rule Rule_1413_triggered {
	meta: description = "Rule # 1413 Suspicious String r3v3ng4ns triggered"
	strings: $suspicious_string = "r3v3ng4ns"
	condition: $suspicious_string
}
rule Rule_1414_triggered {
	meta: description = "Rule # 1414 Suspicious String r57 triggered"
	strings: $suspicious_string = "r57"
	condition: $suspicious_string
}
rule Rule_1415_triggered {
	meta: description = "Rule # 1415 Suspicious String rEd X triggered"
	strings: $suspicious_string = "rEd X"
	condition: $suspicious_string
}
rule Rule_1416_triggered {
	meta: description = "Rule # 1416 Suspicious String rOx triggered"
	strings: $suspicious_string = "rOx"
	condition: $suspicious_string
}
rule Rule_1417_triggered {
	meta: description = "Rule # 1417 Suspicious String rWmpisiBWQglW/n3OBtqwt8T0NwjeiW+8Kd9N triggered"
	strings: $suspicious_string = "rWmpisiBWQglW/n3OBtqwt8T0NwjeiW+8Kd9N"
	condition: $suspicious_string
}
rule Rule_1418_triggered {
	meta: description = "Rule # 1418 Suspicious String rab3oun.net triggered"
	strings: $suspicious_string = "rab3oun.net"
	condition: $suspicious_string
}
rule Rule_1419_triggered {
	meta: description = "Rule # 1419 Suspicious String rad paul triggered"
	strings: $suspicious_string = "rad paul"
	condition: $suspicious_string
}
rule Rule_1420_triggered {
	meta: description = "Rule # 1420 Suspicious String ransomeware@Lalabitch.today triggered"
	strings: $suspicious_string = "ransomeware@Lalabitch.today"
	condition: $suspicious_string
}
rule Rule_1421_triggered {
	meta: description = "Rule # 1421 Suspicious String raslan58 triggered"
	strings: $suspicious_string = "raslan58"
	condition: $suspicious_string
}
rule Rule_1422_triggered {
	meta: description = "Rule # 1422 Suspicious String recaptcha-in triggered"
	strings: $suspicious_string = "recaptcha-in"
	condition: $suspicious_string
}
rule Rule_1423_triggered {
	meta: description = "Rule # 1423 Suspicious String rednoize triggered"
	strings: $suspicious_string = "rednoize"
	condition: $suspicious_string
}
rule Rule_1424_triggered {
	meta: description = "Rule # 1424 Suspicious String regions.com triggered"
	strings: $suspicious_string = "regions.com"
	condition: $suspicious_string
}
rule Rule_1425_triggered {
	meta: description = "Rule # 1425 Suspicious String renownd triggered"
	strings: $suspicious_string = "renownd"
	condition: $suspicious_string
}
rule Rule_1426_triggered {
	meta: description = "Rule # 1426 Suspicious String reply@result.com triggered"
	strings: $suspicious_string = "reply@result.com"
	condition: $suspicious_string
}
rule Rule_1427_triggered {
	meta: description = "Rule # 1427 Suspicious String reputable3811@yandex.com triggered"
	strings: $suspicious_string = "reputable3811@yandex.com"
	condition: $suspicious_string
}
rule Rule_1428_triggered {
	meta: description = "Rule # 1428 Suspicious String resultbox99999@gmail.com triggered"
	strings: $suspicious_string = "resultbox99999@gmail.com"
	condition: $suspicious_string
}
rule Rule_1429_triggered {
	meta: description = "Rule # 1429 Suspicious String resultshere2@gmail.com triggered"
	strings: $suspicious_string = "resultshere2@gmail.com"
	condition: $suspicious_string
}
rule Rule_1430_triggered {
	meta: description = "Rule # 1430 Suspicious String romio2_100@yahoo.com triggered"
...
rule Rule_1432_triggered {
	meta: description = "Rule # 1432 Suspicious String root_devil triggered"
...
rule Rule_1436_triggered {
	meta: description = "Rule # 1436 Suspicious String s3a8ece triggered"
	strings: $suspicious_string = "s3a8ece"
	condition: $suspicious_string
}
rule Rule_1437_triggered {
	meta: description = "Rule # 1437 Suspicious String s3cre3t    triggered"
	strings: $suspicious_string = "s3cre3t   "
	condition: $suspicious_string
}
rule Rule_1438_triggered {
	meta: description = "Rule # 1438 Suspicious String s3n4t00r triggered"
	strings: $suspicious_string = "s3n4t00r"
	condition: $suspicious_string
}
rule Rule_1439_triggered {
	meta: description = "Rule # 1439 Suspicious String sHaf00n triggered"
...
rule Rule_1442_triggered {
	meta: description = "Rule # 1442 Suspicious String sandranix001@hotmail.com triggered"
	strings: $suspicious_string = "sandranix001@hotmail.com"
	condition: $suspicious_string
}
rule Rule_1443_triggered {
	meta: description = "Rule # 1443 Suspicious String sant.marasliyanziylan@gmail.com triggered"
	strings: $suspicious_string = "sant.marasliyanziylan@gmail.com"
	condition: $suspicious_string
}
rule Rule_1444_triggered {
	meta: description = "Rule # 1444 Suspicious String sc.imp.live.com triggered"
	strings: $suspicious_string = "sc.imp.live.com"
	condition: $suspicious_string
}
rule Rule_1445_triggered {
	meta: description = "Rule # 1445 Suspicious String scotiabank.com triggered"
	strings: $suspicious_string = "scotiabank.com"
	condition: $suspicious_string
}
rule Rule_1446_triggered {
	meta: description = "Rule # 1446 Suspicious String sec-w.com triggered"
	strings: $suspicious_string = "sec-w.com"
	condition: $suspicious_string
}
rule Rule_1447_triggered {
	meta: description = "Rule # 1447 Suspicious String semi-priv8 triggered"
	strings: $suspicious_string = "semi-priv8"
	condition: $suspicious_string
}
rule Rule_1448_triggered {
	meta: description = "Rule # 1448 Suspicious String send an report to  triggered"
	strings: $suspicious_string = "send an report to "
	condition: $suspicious_string
}
rule Rule_1449_triggered {
	meta: description = "Rule # 1449 Suspicious String serjoi.colmadory@gmail.com triggered"
...
rule Rule_1452_triggered {
	meta: description = "Rule # 1452 Suspicious String shad0wLin3 triggered"
	strings: $suspicious_string = "shad0wLin3"
	condition: $suspicious_string
}
rule Rule_1453_triggered {
	meta: description = "Rule # 1453 Suspicious String shawnphill77345@aol.in triggered"
	strings: $suspicious_string = "shawnphill77345@aol.in"
	condition: $suspicious_string
}
rule Rule_1454_triggered {
	meta: description = "Rule # 1454 Suspicious String shellbot triggered"
	strings: $suspicious_string = "shellbot"
	condition: $suspicious_string
}
rule Rule_1455_triggered {
	meta: description = "Rule # 1455 Suspicious String shellchk triggered"
	strings: $suspicious_string = "shellchk"
	condition: $suspicious_string
}
rule Rule_1456_triggered {
	meta: description = "Rule # 1456 Suspicious String shellinvoker triggered"
	strings: $suspicious_string = "shellinvoker"
	condition: $suspicious_string
}
rule Rule_1457_triggered {
	meta: description = "Rule # 1457 Suspicious String shellololol triggered"
	strings: $suspicious_string = "shellololol"
	condition: $suspicious_string
}
rule Rule_1458_triggered {
	meta: description = "Rule # 1458 Suspicious String shellw0rm triggered"
	strings: $suspicious_string = "shellw0rm"
	condition: $suspicious_string
}
rule Rule_1459_triggered {
	meta: description = "Rule # 1459 Suspicious String shl-ed1 triggered"
	strings: $suspicious_string = "shl-ed1"
	condition: $suspicious_string
}
rule Rule_1460_triggered {
	meta: description = "Rule # 1460 Suspicious String silent hacker triggered"
	strings: $suspicious_string = "silent hacker"
	condition: $suspicious_string
}
rule Rule_1461_triggered {
	meta: description = "Rule # 1461 Suspicious String skrill triggered"
	strings: $suspicious_string = "skrill"
	condition: $suspicious_string
}
rule Rule_1462_triggered {
	meta: description = "Rule # 1462 Suspicious String skyline@cash4u.com triggered"
	strings: $suspicious_string = "skyline@cash4u.com"
	condition: $suspicious_string
}
rule Rule_1463_triggered {
	meta: description = "Rule # 1463 Suspicious String slac4ever@gmail.com triggered"
	strings: $suspicious_string = "slac4ever@gmail.com"
	condition: $suspicious_string
}
rule Rule_1464_triggered {
	meta: description = "Rule # 1464 Suspicious String solevisible@gmail.com triggered"
	strings: $suspicious_string = "solevisible@gmail.com"
	condition: $suspicious_string
}
rule Rule_1465_triggered {
	meta: description = "Rule # 1465 Suspicious String spKINGS.com triggered"
	strings: $suspicious_string = "spKINGS.com"
	condition: $suspicious_string
}
rule Rule_1466_triggered {
	meta: description = "Rule # 1466 Suspicious String spam_rezult@spammerindo.com triggered"
	strings: $suspicious_string = "spam_rezult@spammerindo.com"
	condition: $suspicious_string
}
rule Rule_1467_triggered {
	meta: description = "Rule # 1467 Suspicious String spendit.laulau@yahoo.co triggered"
	strings: $suspicious_string = "spendit.laulau@yahoo.co"
	condition: $suspicious_string
}
rule Rule_1468_triggered {
	meta: description = "Rule # 1468 Suspicious String spymeta triggered"
	strings: $suspicious_string = "spymeta"
	condition: $suspicious_string
}
rule Rule_1469_triggered {
	meta: description = "Rule # 1469 Suspicious String starktomtht triggered"
	strings: $suspicious_string = "starktomtht"
	condition: $suspicious_string
}
rule Rule_1470_triggered {
	meta: description = "Rule # 1470 Suspicious String startonthisfuckingpoint triggered"
	strings: $suspicious_string = "startonthisfuckingpoint"
	condition: $suspicious_string
}
rule Rule_1471_triggered {
	meta: description = "Rule # 1471 Suspicious String stat-dns.com  triggered"
	strings: $suspicious_string = "stat-dns.com "
	condition: $suspicious_string
}
rule Rule_1472_triggered {
	meta: description = "Rule # 1472 Suspicious String stayinfranschhoek.co.za triggered"
	strings: $suspicious_string = "stayinfranschhoek.co.za"
	condition: $suspicious_string
}
rule Rule_1473_triggered {
	meta: description = "Rule # 1473 Suspicious String storesbrown147@gmail.com triggered"
	strings: $suspicious_string = "storesbrown147@gmail.com"
	condition: $suspicious_string
}
rule Rule_1474_triggered {
	meta: description = "Rule # 1474 Suspicious String sub attacker triggered"
	strings: $suspicious_string = "sub attacker"
	condition: $suspicious_string
}
rule Rule_1475_triggered {
	meta: description = "Rule # 1475 Suspicious String susanalbert1980@gmail.com triggered"
	strings: $suspicious_string = "susanalbert1980@gmail.com"
	condition: $suspicious_string
}
rule Rule_1476_triggered {
	meta: description = "Rule # 1476 Suspicious String suthallen@gmail.com triggered"
	strings: $suspicious_string = "suthallen@gmail.com"
	condition: $suspicious_string
}
rule Rule_1477_triggered {
	meta: description = "Rule # 1477 Suspicious String svtpdagx triggered"
	strings: $suspicious_string = "svtpdagx"
	condition: $suspicious_string
}
rule Rule_1478_triggered {
	meta: description = "Rule # 1478 Suspicious String symlinker triggered"
	strings: $suspicious_string = "symlinker"
	condition: $suspicious_string
}
rule Rule_1479_triggered {
	meta: description = "Rule # 1479 Suspicious String sysctl -n kern triggered"
	strings: $suspicious_string = "sysctl -n kern"
	condition: $suspicious_string
}
rule Rule_1480_triggered {
	meta: description = "Rule # 1480 Suspicious String tHAnks tO Sir ShOcKs triggered"
	strings: $suspicious_string = "tHAnks tO Sir ShOcKs"
	condition: $suspicious_string
}
rule Rule_1481_triggered {
	meta: description = "Rule # 1481 Suspicious String tHAnks tO Timeless triggered"
	strings: $suspicious_string = "tHAnks tO Timeless"
	condition: $suspicious_string
}
rule Rule_1482_triggered {
	meta: description = "Rule # 1482 Suspicious String tafiki triggered"
	strings: $suspicious_string = "tafiki"
	condition: $suspicious_string
}
rule Rule_1483_triggered {
	meta: description = "Rule # 1483 Suspicious String tds-narod.ru triggered"
	strings: $suspicious_string = "tds-narod.ru"
	condition: $suspicious_string
}
rule Rule_1484_triggered {
	meta: description = "Rule # 1484 Suspicious String tesemelgan@gmail.com triggered"
	strings: $suspicious_string = "tesemelgan@gmail.com"
	condition: $suspicious_string
}
rule Rule_1485_triggered {
	meta: description = "Rule # 1485 Suspicious String tl4s.com.sa triggered"
	strings: $suspicious_string = "tl4s.com.sa"
	condition: $suspicious_string
}
rule Rule_1486_triggered {
	meta: description = "Rule # 1486 Suspicious String toolzmorathy1 triggered"
	strings: $suspicious_string = "toolzmorathy1"
	condition: $suspicious_string
}
rule Rule_1487_triggered {
	meta: description = "Rule # 1487 Suspicious String totallyfreecursors.com triggered"
	strings: $suspicious_string = "totallyfreecursors.com"
	condition: $suspicious_string
}
rule Rule_1488_triggered {
	meta: description = "Rule # 1488 Suspicious String try.ciela.co triggered"
	strings: $suspicious_string = "try.ciela.co"
	condition: $suspicious_string
}
rule Rule_1489_triggered {
	meta: description = "Rule # 1489 Suspicious String try.ucr.news triggered"
	strings: $suspicious_string = "try.ucr.news"
	condition: $suspicious_string
}
rule Rule_1490_triggered {
	meta: description = "Rule # 1490 Suspicious String tujuanmail triggered"
	strings: $suspicious_string = "tujuanmail"
	condition: $suspicious_string
}
rule Rule_1491_triggered {
	meta: description = "Rule # 1491 Suspicious String turkblackhats triggered"
	strings: $suspicious_string = "turkblackhats"
	condition: $suspicious_string
}
rule Rule_1492_triggered {
	meta: description = "Rule # 1492 Suspicious String turkishkebab00@gmail.com triggered"
	strings: $suspicious_string = "turkishkebab00@gmail.com"
	condition: $suspicious_string
}
rule Rule_1493_triggered {
	meta: description = "Rule # 1493 Suspicious String tvweipud triggered"
	strings: $suspicious_string = "tvweipud"
	condition: $suspicious_string
}
rule Rule_1494_triggered {
	meta: description = "Rule # 1494 Suspicious String ubhteam.org triggered"
	strings: $suspicious_string = "ubhteam.org"
	condition: $suspicious_string
}
rule Rule_1495_triggered {
	meta: description = "Rule # 1495 Suspicious String uon7bHxvy09 triggered"
	strings: $suspicious_string = "uon7bHxvy09"
	condition: $suspicious_string
}
rule Rule_1496_triggered {
	meta: description = "Rule # 1496 Suspicious String upl0ad triggered"
	strings: $suspicious_string = "upl0ad"
	condition: $suspicious_string
}
rule Rule_1497_triggered {
	meta: description = "Rule # 1497 Suspicious String upload shell and manage site or server using console :D, happy hacking ;) triggered"
	strings: $suspicious_string = "upload shell and manage site or server using console :D, happy hacking ;)"
	condition: $suspicious_string
}
rule Rule_1498_triggered {
	meta: description = "Rule # 1498 Suspicious String upload.sa3eka.com triggered"
	strings: $suspicious_string = "upload.sa3eka.com"
	condition: $suspicious_string
}
rule Rule_1499_triggered {
	meta: description = "Rule # 1499 Suspicious String usaa.com triggered"
	strings: $suspicious_string = "usaa.com"
	condition: $suspicious_string
}
rule Rule_1500_triggered {
	meta: description = "Rule # 1500 Suspicious String usta upload basarili olmadi.Baska siteye dal!! triggered"
	strings: $suspicious_string = "usta upload basarili olmadi.Baska siteye dal!!"
	condition: $suspicious_string
}
rule Rule_1501_triggered {
	meta: description = "Rule # 1501 Suspicious String vSDzq3Md triggered"
	strings: $suspicious_string = "vSDzq3Md"
	condition: $suspicious_string
}
rule Rule_1502_triggered {
	meta: description = "Rule # 1502 Suspicious String van1lle triggered"
	strings: $suspicious_string = "van1lle"
	condition: $suspicious_string
}
rule Rule_1503_triggered {
	meta: description = "Rule # 1503 Suspicious String var miner=new WMP.User triggered"
	strings: $suspicious_string = "var miner=new WMP.User"
	condition: $suspicious_string
}
rule Rule_1504_triggered {
	meta: description = "Rule # 1504 Suspicious String vecweb.net.ua triggered"
	strings: $suspicious_string = "vecweb.net.ua"
	condition: $suspicious_string
}
rule Rule_1505_triggered {
	meta: description = "Rule # 1505 Suspicious String victim@host.com triggered"
	strings: $suspicious_string = "victim@host.com"
	condition: $suspicious_string
}
rule Rule_1506_triggered {
	meta: description = "Rule # 1506 Suspicious String vinsm0ke_id triggered"
	strings: $suspicious_string = "vinsm0ke_id"
	condition: $suspicious_string
}
rule Rule_1507_triggered {
	meta: description = "Rule # 1507 Suspicious String vito-RawckerheaD triggered"
	strings: $suspicious_string = "vito-RawckerheaD"
	condition: $suspicious_string
}
rule Rule_1508_triggered {
	meta: description = "Rule # 1508 Suspicious String void.ru triggered"
	strings: $suspicious_string = "void.ru"
	condition: $suspicious_string
}
rule Rule_1509_triggered {
	meta: description = "Rule # 1509 Suspicious String vulns could lead to total disaters triggered"
	strings: $suspicious_string = "vulns could lead to total disaters"
	condition: $suspicious_string
}
rule Rule_1510_triggered {
	meta: description = "Rule # 1510 Suspicious String vulnscan triggered"
	strings: $suspicious_string = "vulnscan"
	condition: $suspicious_string
}
rule Rule_1511_triggered {
	meta: description = "Rule # 1511 Suspicious String w00t triggered"
	strings: $suspicious_string = "w00t"
	condition: $suspicious_string
}
rule Rule_1512_triggered {
	meta: description = "Rule # 1512 Suspicious String w0lgix-tool triggered"
	strings: $suspicious_string = "w0lgix-tool"
	condition: $suspicious_string
}
rule Rule_1513_triggered {
	meta: description = "Rule # 1513 Suspicious String w4ck1ng triggered"
	strings: $suspicious_string = "w4ck1ng"
	condition: $suspicious_string
}
rule Rule_1514_triggered {
	meta: description = "Rule # 1514 Suspicious String w7h7j7c57.homepage.t-online.de triggered"
	strings: $suspicious_string = "w7h7j7c57.homepage.t-online.de"
	condition: $suspicious_string
}
rule Rule_1515_triggered {
	meta: description = "Rule # 1515 Suspicious String w7sh.syria triggered"
	strings: $suspicious_string = "w7sh.syria"
	condition: $suspicious_string
}
rule Rule_1516_triggered {
	meta: description = "Rule # 1516 Suspicious String walemilton003@gmail.com triggered"
	strings: $suspicious_string = "walemilton003@gmail.com"
	condition: $suspicious_string
}
rule Rule_1517_triggered {
	meta: description = "Rule # 1517 Suspicious String webconsole.php triggered"
	strings: $suspicious_string = "webconsole.php"
	condition: $suspicious_string
}
rule Rule_1518_triggered {
	meta: description = "Rule # 1518 Suspicious String webmaster@altavistadelago.com triggered"
	strings: $suspicious_string = "webmaster@altavistadelago.com"
	condition: $suspicious_string
}
rule Rule_1519_triggered {
	meta: description = "Rule # 1519 Suspicious String webminepool.com triggered"
	strings: $suspicious_string = "webminepool.com"
	condition: $suspicious_string
}
rule Rule_1520_triggered {
	meta: description = "Rule # 1520 Suspicious String weevely backdoor triggered"
	strings: $suspicious_string = "weevely backdoor"
	condition: $suspicious_string
}
rule Rule_1521_triggered {
	meta: description = "Rule # 1521 Suspicious String wellsfargo.com triggered"
	strings: $suspicious_string = "wellsfargo.com"
	condition: $suspicious_string
}
rule Rule_1522_triggered {
	meta: description = "Rule # 1522 Suspicious String wfagoss@gmail.com triggered"
	strings: $suspicious_string = "wfagoss@gmail.com"
	condition: $suspicious_string
}
rule Rule_1523_triggered {
	meta: description = "Rule # 1523 Suspicious String wi.na  triggered"
	strings: $suspicious_string = "wi.na "
	condition: $suspicious_string
}
rule Rule_1524_triggered {
	meta: description = "Rule # 1524 Suspicious String williambell101@yahoo.com triggered"
	strings: $suspicious_string = "williambell101@yahoo.com"
	condition: $suspicious_string
}
rule Rule_1525_triggered {
	meta: description = "Rule # 1525 Suspicious String williambell1233@gmail.com triggered"
	strings: $suspicious_string = "williambell1233@gmail.com"
	condition: $suspicious_string
}
rule Rule_1526_triggered {
	meta: description = "Rule # 1526 Suspicious String wkendy76@blumail.org triggered"
	strings: $suspicious_string = "wkendy76@blumail.org"
	condition: $suspicious_string
}
rule Rule_1527_triggered {
	meta: description = "Rule # 1527 Suspicious String wolu yb dekcah triggered"
	strings: $suspicious_string = "wolu yb dekcah"
	condition: $suspicious_string
}
rule Rule_1528_triggered {
	meta: description = "Rule # 1528 Suspicious String wonderfulboy01@gmai.com triggered"
	strings: $suspicious_string = "wonderfulboy01@gmai.com"
	condition: $suspicious_string
}
rule Rule_1529_triggered {
	meta: description = "Rule # 1529 Suspicious String wp mass info changer triggered"
	strings: $suspicious_string = "wp mass info changer"
	condition: $suspicious_string
}
rule Rule_1530_triggered {
	meta: description = "Rule # 1530 Suspicious String wrgggthhd triggered"
	strings: $suspicious_string = "wrgggthhd"
	condition: $suspicious_string
}
rule Rule_1531_triggered {
	meta: description = "Rule # 1531 Suspicious String wso@protonmail.com triggered"
	strings: $suspicious_string = "wso@protonmail.com"
	condition: $suspicious_string
}
rule Rule_1532_triggered {
	meta: description = "Rule # 1532 Suspicious String www.adobe.com.zip triggered"
	strings: $suspicious_string = "www.adobe.com.zip"
	condition: $suspicious_string
}
rule Rule_1533_triggered {
	meta: description = "Rule # 1533 Suspicious String www.ahdal.com triggered"
	strings: $suspicious_string = "www.ahdal.com"
	condition: $suspicious_string
}
rule Rule_1534_triggered {
	meta: description = "Rule # 1534 Suspicious String www.ayyildiz.org triggered"
	strings: $suspicious_string = "www.ayyildiz.org"
	condition: $suspicious_string
}
rule Rule_1535_triggered {
	meta: description = "Rule # 1535 Suspicious String www.c99.me triggered"
	strings: $suspicious_string = "www.c99.me"
	condition: $suspicious_string
}
rule Rule_1536_triggered {
	meta: description = "Rule # 1536 Suspicious String www.gudangkesehatan.com triggered"
	strings: $suspicious_string = "www.gudangkesehatan.com"
	condition: $suspicious_string
}
rule Rule_1537_triggered {
	meta: description = "Rule # 1537 Suspicious String www.sec-krb.org triggered"
	strings: $suspicious_string = "www.sec-krb.org"
	condition: $suspicious_string
}
rule Rule_1538_triggered {
	meta: description = "Rule # 1538 Suspicious String x shell triggered"
	strings: $suspicious_string = "x shell"
	condition: $suspicious_string
}
rule Rule_1539_triggered {
	meta: description = "Rule # 1539 Suspicious String x'1n73ct  triggered"
	strings: $suspicious_string = "x'1n73ct "
	condition: $suspicious_string
}
rule Rule_1540_triggered {
	meta: description = "Rule # 1540 Suspicious String x1.minerxmr.ru triggered"
	strings: $suspicious_string = "x1.minerxmr.ru"
	condition: $suspicious_string
}
rule Rule_1541_triggered {
	meta: description = "Rule # 1541 Suspicious String x@erebor.dwarfpool.com triggered"
	strings: $suspicious_string = "x@erebor.dwarfpool.com"
	condition: $suspicious_string
}
rule Rule_1542_triggered {
	meta: description = "Rule # 1542 Suspicious String x@moria.dwarfpool.com triggered"
	strings: $suspicious_string = "x@moria.dwarfpool.com"
	condition: $suspicious_string
}
rule Rule_1543_triggered {
	meta: description = "Rule # 1543 Suspicious String xCut10n  triggered"
	strings: $suspicious_string = "xCut10n "
	condition: $suspicious_string
}
rule Rule_1544_triggered {
	meta: description = "Rule # 1544 Suspicious String xLon3ly triggered"
	strings: $suspicious_string = "xLon3ly"
	condition: $suspicious_string
}
rule Rule_1545_triggered {
	meta: description = "Rule # 1545 Suspicious String xXEz triggered"
	strings: $suspicious_string = "xXEz"
	condition: $suspicious_string
}
rule Rule_1546_triggered {
	meta: description = "Rule # 1546 Suspicious String xbgbkyqvqgwu triggered"
	strings: $suspicious_string = "xbgbkyqvqgwu"
	condition: $suspicious_string
}
rule Rule_1547_triggered {
	meta: description = "Rule # 1547 Suspicious String xplOi73r triggered"
	strings: $suspicious_string = "xplOi73r"
	condition: $suspicious_string
}
rule Rule_1548_triggered {
	meta: description = "Rule # 1548 Suspicious String xrob0t.cpanels@gmail.com triggered"
	strings: $suspicious_string = "xrob0t.cpanels@gmail.com"
	condition: $suspicious_string
}
rule Rule_1549_triggered {
	meta: description = "Rule # 1549 Suspicious String xtases no-life triggered"
	strings: $suspicious_string = "xtases no-life"
	condition: $suspicious_string
}
rule Rule_1550_triggered {
	meta: description = "Rule # 1550 Suspicious String y2Google triggered"
	strings: $suspicious_string = "y2Google"
	condition: $suspicious_string
}
rule Rule_1551_triggered {
	meta: description = "Rule # 1551 Suspicious String yahoopassword triggered"
	strings: $suspicious_string = "yahoopassword"
	condition: $suspicious_string
}
rule Rule_1552_triggered {
	meta: description = "Rule # 1552 Suspicious String yang8559420 triggered"
	strings: $suspicious_string = "yang8559420"
	condition: $suspicious_string
}
rule Rule_1553_triggered {
	meta: description = "Rule # 1553 Suspicious String ydteam triggered"
	strings: $suspicious_string = "ydteam"
	condition: $suspicious_string
}
rule Rule_1554_triggered {
	meta: description = "Rule # 1554 Suspicious String youngbloodcharlesx@gmail.com triggered"
	strings: $suspicious_string = "youngbloodcharlesx@gmail.com"
	condition: $suspicious_string
}
rule Rule_1555_triggered {
	meta: description = "Rule # 1555 Suspicious String zPayPal_2018 triggered"
	strings: $suspicious_string = "zPayPal_2018"
	condition: $suspicious_string
}
rule Rule_1556_triggered {
	meta: description = "Rule # 1556 Suspicious String zen.co.uk triggered"
	strings: $suspicious_string = "zen.co.uk"
	condition: $suspicious_string
}
rule Rule_1557_triggered {
	meta: description = "Rule # 1557 Suspicious String zetas.oujda triggered"
	strings: $suspicious_string = "zetas.oujda"
	condition: $suspicious_string
}
rule Rule_1558_triggered {
	meta: description = "Rule # 1558 Suspicious String zhikou.yo2.cn triggered"
	strings: $suspicious_string = "zhikou.yo2.cn"
	condition: $suspicious_string
}
rule Rule_1559_triggered {
	meta: description = "Rule # 1559 Suspicious String zigw triggered"
	strings: $suspicious_string = "zigw"
	condition: $suspicious_string
}
rule Rule_1560_triggered {
	meta: description = "Rule # 1560 Suspicious String ziteditora.com.br triggered"
	strings: $suspicious_string = "ziteditora.com.br"
	condition: $suspicious_string
}
rule Rule_1561_triggered {
	meta: description = "Rule # 1561 Suspicious String zoozoo triggered"
	strings: $suspicious_string = "zoozoo"
	condition: $suspicious_string
}
rule Rule_1562_triggered {
	meta: description = "Rule # 1562 Suspicious String 互相伤害啊 triggered"
	strings: $suspicious_string = "互相伤害啊"
	condition: $suspicious_string
}
rule Rule_1563_triggered {
	meta: description = "Rule # 1563 Suspicious String watchd0g.sh triggered"
	strings: $suspicious_string = "watchd0g.sh"
	condition: $suspicious_string
}
rule Rule_1564_triggered {
	meta: description = "Rule # 1564 Suspicious String systemdo triggered"
	strings: $suspicious_string = "systemdo"
	condition: $suspicious_string
}
rule Rule_1565_triggered {
	meta: description = "Rule # 1565 Suspicious String 222.184.79.11 triggered"
	strings: $suspicious_string = "222.184.79.11"
	condition: $suspicious_string
}
rule Rule_1566_triggered {
	meta: description = "Rule # 1566 Suspicious String dada.x86_64 triggered"
	strings: $suspicious_string = "dada.x86_64"
	condition: $suspicious_string
}
rule Rule_1567_triggered {
	meta: description = "Rule # 1567 Suspicious String bbc.servehalflife.com triggered"
	strings: $suspicious_string = "bbc.servehalflife.com"
	condition: $suspicious_string
}
rule Rule_1568_triggered {
	meta: description = "Rule # 1568 Suspicious String 190.60.206.11 triggered"
	strings: $suspicious_string = "190.60.206.11"
	condition: $suspicious_string
}
rule Rule_1569_triggered {
	meta: description = "Rule # 1569 Suspicious String 182.18.8.69 triggered"
	strings: $suspicious_string = "182.18.8.69"
	condition: $suspicious_string
}
rule Rule_1570_triggered {
	meta: description = "Rule # 1570 Suspicious String jbos.7766.org triggered"
	strings: $suspicious_string = "jbos.7766.org"
	condition: $suspicious_string
}
rule Rule_1571_triggered {
	meta: description = "Rule # 1571 Suspicious String 115.231.218.38 triggered"
	strings: $suspicious_string = "115.231.218.38"
	condition: $suspicious_string
}
rule Rule_1572_triggered {
	meta: description = "Rule # 1572 Suspicious String zayaflowers.ru/3.03_conf triggered"
	strings: $suspicious_string = "zayaflowers.ru/3.03_conf"
	condition: $suspicious_string
}
rule Rule_1573_triggered {
	meta: description = "Rule # 1573 Suspicious String 3.03_config triggered"
	strings: $suspicious_string = "3.03_config"
	condition: $suspicious_string
}
rule Rule_1574_triggered {
	meta: description = "Rule # 1574 Suspicious String gsqdecfoo triggered"
	strings: $suspicious_string = "gsqdecfoo"
	condition: $suspicious_string
}
rule Rule_1575_triggered {
	meta: description = "Rule # 1575 Suspicious String dydwfdnuls triggered"
	strings: $suspicious_string = "dydwfdnuls"
	condition: $suspicious_string
}
rule Rule_1576_triggered {
	meta: description = "Rule # 1576 Suspicious String rqutuvbow triggered"
	strings: $suspicious_string = "rqutuvbow"
	condition: $suspicious_string
}
rule Rule_1577_triggered {
	meta: description = "Rule # 1577 Suspicious String osvbkai triggered"
	strings: $suspicious_string = "osvbkai"
	condition: $suspicious_string
}
rule Rule_1578_triggered {
	meta: description = "Rule # 1578 Suspicious String fwaywusurl triggered"
	strings: $suspicious_string = "fwaywusurl"
	condition: $suspicious_string
}
rule Rule_1579_triggered {
	meta: description = "Rule # 1579 Suspicious String O7JBlDzqAkyShKcoEsTQSmtQHEM4aY0G triggered"
	strings: $suspicious_string = "O7JBlDzqAkyShKcoEsTQSmtQHEM4aY0G"
	condition: $suspicious_string
}
rule Rule_1580_triggered {
	meta: description = "Rule # 1580 Suspicious String RsyncWeakCheck triggered"
	strings: $suspicious_string = "RsyncWeakCheck"
	condition: $suspicious_string
}
rule Rule_1581_triggered {
	meta: description = "Rule # 1581 Suspicious String WScript.shell triggered"
	strings: $suspicious_string = "WScript.shell"
	condition: $suspicious_string
}
rule Rule_1582_triggered {
	meta: description = "Rule # 1582 Suspicious String WSHShell triggered"
	strings: $suspicious_string = "WSHShell"
	condition: $suspicious_string
}
rule Rule_1583_triggered {
	meta: description = "Rule # 1583 Suspicious String Stager uploaded successfully triggered"
	strings: $suspicious_string = "Stager uploaded successfully"
	condition: $suspicious_string
}
rule Rule_1584_triggered {
	meta: description = "Rule # 1584 Suspicious String chpasswd.sh triggered"
	strings: $suspicious_string = "chpasswd.sh"
	condition: $suspicious_string
}
rule Rule_1585_triggered {
	meta: description = "Rule # 1585 Suspicious String Mr Secretz Shell triggered"
	strings: $suspicious_string = "Mr Secretz Shell"
	condition: $suspicious_string
}
rule Rule_1586_triggered {
	meta: description = "Rule # 1586 Suspicious String CloudNine hehe triggered"
	strings: $suspicious_string = "CloudNine hehe"
	condition: $suspicious_string
}
rule Rule_1587_triggered {
	meta: description = "Rule # 1587 Suspicious String Boycot israel triggered"
	strings: $suspicious_string = "Boycot israel"
	condition: $suspicious_string
}
rule Rule_1588_triggered {
	meta: description = "Rule # 1588 Suspicious String Hacked By faisalr triggered"
	strings: $suspicious_string = "Hacked By faisalr"
	condition: $suspicious_string
}
rule Rule_1589_triggered {
	meta: description = "Rule # 1589 Suspicious String hfwG2jBM827zx triggered"
	strings: $suspicious_string = "hfwG2jBM827zx"
	condition: $suspicious_string
}
rule Rule_1590_triggered {
	meta: description = "Rule # 1590 Suspicious String googletagmanaaer.com triggered"
	strings: $suspicious_string = "googletagmanaaer.com"
	condition: $suspicious_string
}
rule Rule_1591_triggered {
	meta: description = "Rule # 1591 Suspicious String prizehdru triggered"
	strings: $suspicious_string = "prizehdru"
	condition: $suspicious_string
}
rule Rule_1592_triggered {
	meta: description = "Rule # 1592 Suspicious String Mister Spy & Souheyl Bypass Shell triggered"
	strings: $suspicious_string = "Mister Spy & Souheyl Bypass Shell"
	condition: $suspicious_string
}
rule Rule_1593_triggered {
	meta: description = "Rule # 1593 Suspicious String Welcome To Our Shell triggered"
	strings: $suspicious_string = "Welcome To Our Shell"
	condition: $suspicious_string
}
rule Rule_1594_triggered {
	meta: description = "Rule # 1594 Suspicious String WSCRIPT.SHELL triggered"
	strings: $suspicious_string = "WSCRIPT.SHELL"
	condition: $suspicious_string
}
rule Rule_1595_triggered {
	meta: description = "Rule # 1595 Suspicious String One_LAYS triggered"
	strings: $suspicious_string = "One_LAYS"
	condition: $suspicious_string
}
rule Rule_1596_triggered {
	meta: description = "Rule # 1596 Suspicious String PHP Encode v1.0 by zeura.com triggered"
	strings: $suspicious_string = "PHP Encode v1.0 by zeura.com"
	condition: $suspicious_string
}
rule Rule_1597_triggered {
	meta: description = "Rule # 1597 Suspicious String LUL404 triggered"
	strings: $suspicious_string = "LUL404"
	condition: $suspicious_string
}
rule Rule_1598_triggered {
	meta: description = "Rule # 1598 Suspicious String Bersih PAK! triggered"
	strings: $suspicious_string = "Bersih PAK!"
	condition: $suspicious_string
}
rule Rule_1599_triggered {
	meta: description = "Rule # 1599 Suspicious String Gagal PAK!!! triggered"
	strings: $suspicious_string = "Gagal PAK!!!"
	condition: $suspicious_string
}
rule Rule_1600_triggered {
	meta: description = "Rule # 1600 Suspicious String W3LL SQUAD triggered"
	strings: $suspicious_string = "W3LL SQUAD"
	condition: $suspicious_string
}
rule Rule_1601_triggered {
	meta: description = "Rule # 1601 Suspicious String dl/nygt.whiqp_c triggered"
	strings: $suspicious_string = "dl/nygt.whiqp_c"
	condition: $suspicious_string
}
rule Rule_1602_triggered {
	meta: description = "Rule # 1602 Suspicious String mdXfyCGA8070 triggered"
	strings: $suspicious_string = "mdXfyCGA8070"
	condition: $suspicious_string
}
rule Rule_1603_triggered {
	meta: description = "Rule # 1603 Suspicious String MzcoOhsRdQ9rY0RVPSEeZR0RJABRc3VIFB8vPyB triggered"
	strings: $suspicious_string = "MzcoOhsRdQ9rY0RVPSEeZR0RJABRc3VIFB8vPyB"
	condition: $suspicious_string
}
rule Rule_1604_triggered {
	meta: description = "Rule # 1604 Suspicious String ooRKSGZh2631 triggered"
	strings: $suspicious_string = "ooRKSGZh2631"
	condition: $suspicious_string
}
rule Rule_1605_triggered {
	meta: description = "Rule # 1605 Suspicious String dxNNrWQccDmaVMALjoEPDAXpoqCRbaTBbwTVbXc triggered"
	strings: $suspicious_string = "dxNNrWQccDmaVMALjoEPDAXpoqCRbaTBbwTVbXc"
	condition: $suspicious_string
}
rule Rule_1606_triggered {
	meta: description = "Rule # 1606 Suspicious String c4a4629314f86e064c94188729fcdf1cc4a4629 triggered"
	strings: $suspicious_string = "c4a4629314f86e064c94188729fcdf1cc4a4629"
	condition: $suspicious_string
}
rule Rule_1607_triggered {
	meta: description = "Rule # 1607 Suspicious String UcpEVe6863 triggered"
	strings: $suspicious_string = "UcpEVe6863"
	condition: $suspicious_string
}
rule Rule_1608_triggered {
	meta: description = "Rule # 1608 Suspicious String YwmI1780 triggered"
	strings: $suspicious_string = "YwmI1780"
	condition: $suspicious_string
}
rule Rule_1609_triggered {
	meta: description = "Rule # 1609 Suspicious String <h1>#p@$c@#</h1> triggered"
	strings: $suspicious_string = "<h1>#p@$c@#</h1>"
	condition: $suspicious_string
}
rule Rule_1610_triggered {
	meta: description = "Rule # 1610 Suspicious String HUSA triggered"
	strings: $suspicious_string = "HUSA"
	condition: $suspicious_string
}
rule Rule_1611_triggered {
	meta: description = "Rule # 1611 Suspicious String Shabab Hacker triggered"
	strings: $suspicious_string = "Shabab Hacker"
	condition: $suspicious_string
}
rule Rule_1612_triggered {
	meta: description = "Rule # 1612 Suspicious String scripts.trasnaltemyrecords.com triggered"
	strings: $suspicious_string = "scripts.trasnaltemyrecords.com"
	condition: $suspicious_string
}
rule Rule_1613_triggered {
	meta: description = "Rule # 1613 Suspicious String by aDriv4 triggered"
	strings: $suspicious_string = "by aDriv4"
	condition: $suspicious_string
}
rule Rule_1614_triggered {
	meta: description = "Rule # 1614 Suspicious String xNot_RespondinGx Gans triggered"
	strings: $suspicious_string = "xNot_RespondinGx Gans"
	condition: $suspicious_string
}
rule Rule_1615_triggered {
	meta: description = "Rule # 1615 Suspicious String extremecrew triggered"
	strings: $suspicious_string = "extremecrew"
	condition: $suspicious_string
}
rule Rule_1616_triggered {
	meta: description = "Rule # 1616 Suspicious String Hajar Goblok!!! triggered"
	strings: $suspicious_string = "Hajar Goblok!!!"
	condition: $suspicious_string
}
rule Rule_1617_triggered {
	meta: description = "Rule # 1617 Suspicious String cek Disini goblok!!! triggered"
	strings: $suspicious_string = "cek Disini goblok!!!"
	condition: $suspicious_string
}
rule Rule_1618_triggered {
	meta: description = "Rule # 1618 Suspicious String PRO Mailer V2 triggered"
	strings: $suspicious_string = "PRO Mailer V2"
	condition: $suspicious_string
}
rule Rule_1619_triggered {
	meta: description = "Rule # 1619 Suspicious String Mailer Inbox Sender triggered"
	strings: $suspicious_string = "Mailer Inbox Sender"
	condition: $suspicious_string
}
rule Rule_1620_triggered {
	meta: description = "Rule # 1620 Suspicious String MAILER IS UNABLE TO CONNECT SMTP !! triggered"
	strings: $suspicious_string = "MAILER IS UNABLE TO CONNECT SMTP !!"
	condition: $suspicious_string
}
rule Rule_1621_triggered {
	meta: description = "Rule # 1621 Suspicious String RECEPIENT CAN'T RECEIVE MESSAGE triggered"
	strings: $suspicious_string = "RECEPIENT CAN'T RECEIVE MESSAGE"
	condition: $suspicious_string
}
rule Rule_1622_triggered {
	meta: description = "Rule # 1622 Suspicious String adriv4 triggered"
	strings: $suspicious_string = "adriv4"
	condition: $suspicious_string
}
rule Rule_1623_triggered {
	meta: description = "Rule # 1623 Suspicious String Leaf PHP Mailer by [leafmailer.pw] triggered"
	strings: $suspicious_string = "Leaf PHP Mailer by [leafmailer.pw]"
	condition: $suspicious_string
}
rule Rule_1624_triggered {
	meta: description = "Rule # 1624 Suspicious String 6319a819898755e8.paste.se triggered"
	strings: $suspicious_string = "6319a819898755e8.paste.se"
	condition: $suspicious_string
}
rule Rule_1625_triggered {
	meta: description = "Rule # 1625 Suspicious String pastebin.com/raw/3ByK3R00 triggered"
	strings: $suspicious_string = "pastebin.com/raw/3ByK3R00"
	condition: $suspicious_string
}
rule Rule_1626_triggered {
	meta: description = "Rule # 1626 Suspicious String smevkpathan triggered"
	strings: $suspicious_string = "smevkpathan"
	condition: $suspicious_string
}
rule Rule_1627_triggered {
	meta: description = "Rule # 1627 Suspicious String SmEvK_PaThAn Shell v3 Coded by Kashif Khan triggered"
	strings: $suspicious_string = "SmEvK_PaThAn Shell v3 Coded by Kashif Khan"
	condition: $suspicious_string
}
rule Rule_1628_triggered {
	meta: description = "Rule # 1628 Suspicious String Edit Shell according to your choice. triggered"
	strings: $suspicious_string = "Edit Shell according to your choice."
	condition: $suspicious_string
}
rule Rule_1629_triggered {
	meta: description = "Rule # 1629 Suspicious String Symlink Bypassed Successfully! triggered"
	strings: $suspicious_string = "Symlink Bypassed Successfully!"
	condition: $suspicious_string
}
rule Rule_1630_triggered {
	meta: description = "Rule # 1630 Suspicious String Symlink Bypass 2014 by Mindless Injector triggered"
	strings: $suspicious_string = "Symlink Bypass 2014 by Mindless Injector"
	condition: $suspicious_string
}
rule Rule_1631_triggered {
	meta: description = "Rule # 1631 Suspicious String Pak Cyber Skullz triggered"
	strings: $suspicious_string = "Pak Cyber Skullz"
	condition: $suspicious_string
}
rule Rule_1632_triggered {
	meta: description = "Rule # 1632 Suspicious String Symlink Bypass 2017 triggered"
	strings: $suspicious_string = "Symlink Bypass 2017"
	condition: $suspicious_string
}
rule Rule_1633_triggered {
	meta: description = "Rule # 1633 Suspicious String Recoded By Con7ext triggered"
	strings: $suspicious_string = "Recoded By Con7ext"
	condition: $suspicious_string
}
rule Rule_1634_triggered {
	meta: description = "Rule # 1634 Suspicious String Not 404 Found Cyber Team triggered"
	strings: $suspicious_string = "Not 404 Found Cyber Team"
	condition: $suspicious_string
}
rule Rule_1635_triggered {
	meta: description = "Rule # 1635 Suspicious String Hacked By White System triggered"
	strings: $suspicious_string = "Hacked By White System"
	condition: $suspicious_string
}
rule Rule_1636_triggered {
	meta: description = "Rule # 1636 Suspicious String TurkicHackersRulez triggered"
	strings: $suspicious_string = "TurkicHackersRulez"
	condition: $suspicious_string
}
rule Rule_1637_triggered {
	meta: description = "Rule # 1637 Suspicious String 1lHfauyg874i6k triggered"
	strings: $suspicious_string = "1lHfauyg874i6k"
	condition: $suspicious_string
}
rule Rule_1638_triggered {
	meta: description = "Rule # 1638 Suspicious String 4_pkgndolc9eyfst triggered"
	strings: $suspicious_string = "4_pkgndolc9eyfst"
	condition: $suspicious_string
}
rule Rule_1639_triggered {
	meta: description = "Rule # 1639 Suspicious String function mjfub triggered"
	strings: $suspicious_string = "function mjfub"
	condition: $suspicious_string
}
rule Rule_1640_triggered {
	meta: description = "Rule # 1640 Suspicious String Symlink based cpanel cracking wala jugaad XD triggered"
	strings: $suspicious_string = "Symlink based cpanel cracking wala jugaad XD"
	condition: $suspicious_string
}
rule Rule_1641_triggered {
	meta: description = "Rule # 1641 Suspicious String cpanel cracker triggered"
	strings: $suspicious_string = "cpanel cracker"
	condition: $suspicious_string
}
rule Rule_1642_triggered {
	meta: description = "Rule # 1642 Suspicious String cpanelcracking triggered"
	strings: $suspicious_string = "cpanelcracking"
	condition: $suspicious_string
}
rule Rule_1643_triggered {
	meta: description = "Rule # 1643 Suspicious String Hacker Indonesia triggered"
	strings: $suspicious_string = "Hacker Indonesia"
	condition: $suspicious_string
}
rule Rule_1644_triggered {
	meta: description = "Rule # 1644 Suspicious String Indonesian Hacker triggered"
	strings: $suspicious_string = "Indonesian Hacker"
	condition: $suspicious_string
}
rule Rule_1645_triggered {
	meta: description = "Rule # 1645 Suspicious String Hacker Rohil triggered"
	strings: $suspicious_string = "Hacker Rohil"
	condition: $suspicious_string
}
rule Rule_1646_triggered {
	meta: description = "Rule # 1646 Suspicious String Hacker Riau triggered"
	strings: $suspicious_string = "Hacker Riau"
	condition: $suspicious_string
}
rule Rule_1647_triggered {
	meta: description = "Rule # 1647 Suspicious String Hacker Pekanbaru triggered"
	strings: $suspicious_string = "Hacker Pekanbaru"
	condition: $suspicious_string
}
rule Rule_1648_triggered {
	meta: description = "Rule # 1648 Suspicious String Hacker 2018 triggered"
	strings: $suspicious_string = "Hacker 2018"
	condition: $suspicious_string
}
rule Rule_1649_triggered {
	meta: description = "Rule # 1649 Suspicious String Defacer Terbaru triggered"
	strings: $suspicious_string = "Defacer Terbaru"
	condition: $suspicious_string
}
rule Rule_1650_triggered {
	meta: description = "Rule # 1650 Suspicious String Rohil Cyber Army triggered"
	strings: $suspicious_string = "Rohil Cyber Army"
	condition: $suspicious_string
}
rule Rule_1651_triggered {
	meta: description = "Rule # 1651 Suspicious String RCA TEAM triggered"
	strings: $suspicious_string = "RCA TEAM"
	condition: $suspicious_string
}
rule Rule_1652_triggered {
	meta: description = "Rule # 1652 Suspicious String PANTESTER triggered"
	strings: $suspicious_string = "PANTESTER"
	condition: $suspicious_string
}
rule Rule_1653_triggered {
	meta: description = "Rule # 1653 Suspicious String PANTESTED triggered"
	strings: $suspicious_string = "PANTESTED"
	condition: $suspicious_string
}
rule Rule_1654_triggered {
	meta: description = "Rule # 1654 Suspicious String Hacker Dunia triggered"
	strings: $suspicious_string = "Hacker Dunia"
	condition: $suspicious_string
}
rule Rule_1655_triggered {
	meta: description = "Rule # 1655 Suspicious String Hack Website triggered"
	strings: $suspicious_string = "Hack Website"
	condition: $suspicious_string
}
rule Rule_1656_triggered {
	meta: description = "Rule # 1656 Suspicious String Hack System triggered"
	strings: $suspicious_string = "Hack System"
	condition: $suspicious_string
}
rule Rule_1657_triggered {
	meta: description = "Rule # 1657 Suspicious String System Hacked triggered"
	strings: $suspicious_string = "System Hacked"
	condition: $suspicious_string
}
rule Rule_1658_triggered {
	meta: description = "Rule # 1658 Suspicious String Mr.4JIE triggered"
	strings: $suspicious_string = "Mr.4JIE"
	condition: $suspicious_string
}
rule Rule_1659_triggered {
	meta: description = "Rule # 1659 Suspicious String Jakarta Paranoid triggered"
	strings: $suspicious_string = "Jakarta Paranoid"
	condition: $suspicious_string
}
rule Rule_1660_triggered {
	meta: description = "Rule # 1660 Suspicious String Mr.Onion triggered"
	strings: $suspicious_string = "Mr.Onion"
	condition: $suspicious_string
}
rule Rule_1661_triggered {
	meta: description = "Rule # 1661 Suspicious String Mr.Tahusumedang triggered"
	strings: $suspicious_string = "Mr.Tahusumedang"
	condition: $suspicious_string
}
rule Rule_1662_triggered {
	meta: description = "Rule # 1662 Suspicious String Mr.satsat triggered"
	strings: $suspicious_string = "Mr.satsat"
	condition: $suspicious_string
}
rule Rule_1663_triggered {
	meta: description = "Rule # 1663 Suspicious String Cemen Kun triggered"
	strings: $suspicious_string = "Cemen Kun"
	condition: $suspicious_string
}
rule Rule_1664_triggered {
	meta: description = "Rule # 1664 Suspicious String Mr.IX triggered"
	strings: $suspicious_string = "Mr.IX"
	condition: $suspicious_string
}
rule Rule_1665_triggered {
	meta: description = "Rule # 1665 Suspicious String Infinity Cyber Team triggered"
	strings: $suspicious_string = "Infinity Cyber Team"
	condition: $suspicious_string
}
rule Rule_1666_triggered {
	meta: description = "Rule # 1666 Suspicious String Mr.Donut's triggered"
	strings: $suspicious_string = "Mr.Donut's"
	condition: $suspicious_string
}
rule Rule_1667_triggered {
	meta: description = "Rule # 1667 Suspicious String Evil-net triggered"
	strings: $suspicious_string = "Evil-net"
	condition: $suspicious_string
}
rule Rule_1668_triggered {
	meta: description = "Rule # 1668 Suspicious String M3T4L triggered"
	strings: $suspicious_string = "M3T4L"
	condition: $suspicious_string
}
rule Rule_1669_triggered {
	meta: description = "Rule # 1669 Suspicious String CasusParmak triggered"
	strings: $suspicious_string = "CasusParmak"
	condition: $suspicious_string
}
rule Rule_1670_triggered {
	meta: description = "Rule # 1670 Suspicious String MixPr0 triggered"
	strings: $suspicious_string = "MixPr0"
	condition: $suspicious_string
}
rule Rule_1671_triggered {
	meta: description = "Rule # 1671 Suspicious String ByIllegaL triggered"
	strings: $suspicious_string = "ByIllegaL"
	condition: $suspicious_string
}
rule Rule_1672_triggered {
	meta: description = "Rule # 1672 Suspicious String Raiz0WorM triggered"
